...
class DBEntriesHookSet extends AbstractHookSet
{
    ...
    public function moveEntriesUnderDBName(array $dbNameToFieldNames) : array
    {
        ...
        $dbNameToFieldNames['meta'] = App::applyFilters(HookNames::MOVE_ENTRIES_UNDER_DB_NAME_META_FIELDS, ['fullSchema', 'typeName']);
        $dbNameToFieldNames['context'] = App::applyFilters(HookNames::MOVE_ENTRIES_UNDER_DB_NAME_CONTEXT_FIELDS, ['var', 'context']);
