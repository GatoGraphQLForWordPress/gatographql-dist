...
if (!\class_exists('GatoExternalPrefixByGatoGraphQL\\CastToType')) {
    ...
    class CastToType
    {
         ...
         * @return mixed|null
         */
        function cast($value, $type, $array2null = \true, $allow_empty = \true)
        {
         ...
         */
        function _int($value, $array2null = \true, $allow_empty = \true)
        {
            if (\is_int($value)) {
                return $value;
         ...
         */
        function _float($value, $array2null = \true, $allow_empty = \true)
        {
            if (\is_float($value)) {
                return $value;
            } elseif ($array2null === \false && \is_array($value)) {
         ...
         */
        function _string($value, $array2null = \true, $allow_empty = \true)
        {
         ...
         * @return array|null
         */
        function _array($value, $allow_empty = \true)
        {
         ...
         * @return object|null
         */
        function _object($value, $allow_empty = \true)
        {
         ...
         * @return array|null
         */
        function recurse($value, $method, $allow_empty = \true)
        {
            if (\is_array($value)) {
                if (\count($value) === 0) {
                    if ($allow_empty === \true) {
         ...
         */
        function spl_helper($value, $method, $array2null = \true, $allow_empty = \true)
        {
