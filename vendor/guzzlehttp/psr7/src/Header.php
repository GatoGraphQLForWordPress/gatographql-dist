...
final class Header
{
    ...
    {
        \GatoExternalPrefixByGatoGraphQL\trigger_deprecation('guzzlehttp/psr7', '2.3', 'Header::normalize() is deprecated and will be removed in guzzlehttp/psr7 3.0. Use Header::splitList() instead.');
        $result = [];
        foreach ((array) $header as $value) {
