...
class ObjectResolutionFeedback extends \PoP\ComponentModel\Feedback\AbstractQueryFeedback implements \PoP\ComponentModel\Feedback\ObjectResolutionFeedbackInterface
{
     ...
     * @param array<string|int,EngineIterationFieldSet> $idFieldSet
     */
    public static function fromObjectTypeFieldResolutionFeedback(\PoP\ComponentModel\Feedback\ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback, RelationalTypeResolverInterface $relationalTypeResolver, Directive $directive, array $idFieldSet) : self
    {
