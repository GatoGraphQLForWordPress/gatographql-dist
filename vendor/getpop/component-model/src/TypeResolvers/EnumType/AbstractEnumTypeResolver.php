...
abstract class AbstractEnumTypeResolver extends AbstractTypeResolver implements \PoP\ComponentModel\TypeResolvers\EnumType\EnumTypeResolverInterface
{
    ...
    protected final function validateIsString($inputValue, AstInterface $astNode, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        $inputValueAsString = $inputValue instanceof stdClass ? $this->getOutputService()->jsonEncodeArrayOrStdClassValue($inputValue) : (string) $inputValue;
        $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(InputValueCoercionGraphQLSpecErrorFeedbackItemProvider::class, InputValueCoercionGraphQLSpecErrorFeedbackItemProvider::E_5_6_1_18, [$inputValueAsString, $this->getMaybeNamespacedTypeName()]), $astNode));
    }
    /**
     * Return as is
     *
     ...
     * @return string[]
     */
    public final function getConsolidatedEnumValues() : array
    {
    ...
    public final function getConsolidatedAdminEnumValues() : array
    {
        // Cache the result
        if ($this->consolidatedAdminEnumValuesCache !== null) {
            return $this->consolidatedAdminEnumValuesCache;
        }
        return $this->consolidatedAdminEnumValuesCache = App::applyFilters(\PoP\ComponentModel\TypeResolvers\EnumType\HookNames::ADMIN_ENUM_VALUES, $this->getSensitiveEnumValues(), $this);
    }
    public final function getConsolidatedEnumValueDescription(string $enumValue) : ?string
    {
        // Cache the result
        ...
        return $this->consolidatedEnumValueDescriptionCache[$enumValue] = App::applyFilters(\PoP\ComponentModel\TypeResolvers\EnumType\HookNames::ENUM_VALUE_DESCRIPTION, $this->getEnumValueDescription($enumValue), $this, $enumValue);
    }
    public final function getConsolidatedEnumValueDeprecationMessage(string $enumValue) : ?string
    {
        // Cache the result
        ...
        return $this->consolidatedEnumValueDeprecationMessageCache[$enumValue] = App::applyFilters(\PoP\ComponentModel\TypeResolvers\EnumType\HookNames::ENUM_VALUE_DEPRECATION_MESSAGE, $this->getEnumValueDeprecationMessage($enumValue), $this, $enumValue);
    }
    /**
     ...
     */
    public final function getEnumSchemaDefinition() : array
    {
        // Cache the result
     ...
     * @return array<string,mixed>
     */
    public final function getEnumValueSchemaDefinition(string $enumValue) : array
    {
        // Cache the result
        if (isset($this->schemaDefinitionForEnumValueCache[$enumValue])) {
            return $this->schemaDefinitionForEnumValueCache[$enumValue];
        }
        $enumValueSchemaDefinition = [SchemaDefinition::VALUE => $enumValue];
        ...
        if ($deprecationMessage = $this->getConsolidatedEnumValueDeprecationMessage($enumValue)) {
            $enumValueSchemaDefinition[SchemaDefinition::DEPRECATED] = \true;
    ...
    {
        return [SchemaDefinition::IS_SENSITIVE_DATA_ELEMENT => \in_array($enumValue, $this->getConsolidatedAdminEnumValues())];
    }
    /**
     ...
     * @return array<string,mixed>
     */
    public final function getConsolidatedEnumValueExtensionsSchemaDefinition(string $enumValue) : array
    {
