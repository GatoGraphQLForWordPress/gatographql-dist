...
class HookNames
{
    public final const INPUT_FIELD_NAME_TYPE_RESOLVERS = __CLASS__ . ':input-field-name-type-resolvers';
    public final const INPUT_FIELD_DESCRIPTION = __CLASS__ . ':input-field-description';
    public final const INPUT_FIELD_DEFAULT_VALUE = __CLASS__ . ':input-field-default-value';
