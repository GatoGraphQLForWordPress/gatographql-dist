...
interface InputObjectTypeResolverInterface extends DeprecatableInputTypeResolverInterface
{
     ...
     */
    public function validateInputValue(stdClass $inputValue, AstInterface $astNode, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void;
