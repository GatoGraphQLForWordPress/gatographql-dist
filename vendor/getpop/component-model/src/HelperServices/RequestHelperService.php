...
class RequestHelperService implements \PoP\ComponentModel\HelperServices\RequestHelperServiceInterface
{
    ...
    public function getComponentModelCurrentURL() : ?string
    {
        ...
        $remove_params = (array) App::applyFilters(self::HOOK_CURRENT_URL_REMOVE_PARAMS, [Params::VERSION, Params::COMPONENTFILTER, Params::COMPONENTPATHS, Params::ACTION_PATH, Params::DATA_OUTPUT_ITEMS, Params::DATA_SOURCE, Params::DATAOUTPUTMODE, Params::DATABASESOUTPUTMODE, Params::OUTPUT, Params::DATASTRUCTURE, DefinitionsParams::MANGLED, Params::EXTRA_ROUTES, Params::ACTIONS]);
        $url = GeneralUtils::removeQueryArgs($remove_params, $requestedFullURL);
