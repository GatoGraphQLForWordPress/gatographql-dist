...
class GeneralUtils
{
     ...
     */
    public static function generateRandomString(int $length = 6, bool $addtime = \true, string $characters = 'abcdefghijklmnopqrstuvwxyz') : string
    {
        $randomString = '';
        for ($i = 0; $i < $length; $i++) {
    ...
    {
        return \substr($url, \strlen(self::getDomain($url, \true)));
    }
