...
class SuggestionFeedbackItemProvider extends AbstractFeedbackItemProvider
{
    ...
    {
        return match ($code) {
            self::S1 => $this->__('To execute multiple queries in a single request, add the following operation to the GraphQL query, and execute it: `query %s { id }`', 'gatographql'),
