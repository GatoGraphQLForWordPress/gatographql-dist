...
abstract class AbstractOneofMutationResolver extends \PoP\ComponentModel\MutationResolvers\AbstractMutationResolver
{
     ...
     */
    protected function getInputFieldMutationResolver(string $inputFieldName) : \PoP\ComponentModel\MutationResolvers\MutationResolverInterface
    {
     ...
     * @throws AbstractValueResolutionPromiseException
     */
    protected final function getInputFieldMutationResolverAndOneOfFieldDataAccessor(InputObjectSubpropertyFieldDataAccessorInterface $inputObjectFieldArgumentFieldDataAccessor) : array
    {
     ...
     * @throws AbstractValueResolutionPromiseException
     */
    protected final function getOneOfFieldDataAccessor(InputObjectSubpropertyFieldDataAccessorInterface $inputObjectFieldArgumentFieldDataAccessor, string $oneOfPropertyName) : InputObjectSubpropertyFieldDataAccessorInterface
    {
