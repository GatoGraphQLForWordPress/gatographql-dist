...
class FormInputConstants
{
    ...
    // Watch out! They also cannot be true => "1" and false "0" because then it doesn't send the keys in the array, then we have [Yes, No] with the values actually inverted!
    public const BOOLSTRING_TRUE = 'true';
    public const BOOLSTRING_FALSE = 'false';
}
