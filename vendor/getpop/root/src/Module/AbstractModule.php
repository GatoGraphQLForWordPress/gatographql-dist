...
abstract class AbstractModule implements ModuleInterface
{
     ...
     */
    public final function initialize(array $configuration, bool $skipSchema, array $skipSchemaModuleClasses) : void
    {
     ...
     */
    public final function initializeSystem() : void
    {
     ...
     */
    public abstract function getDependedModuleClasses() : array;
    /**
     ...
     * @param array<class-string<ModuleInterface>> $skipSchemaModuleClasses
     */
    protected function defineRuntimeConstants(bool $skipSchema, array $skipSchemaModuleClasses) : void
    {
    }
    /**
    ...
    public function calculateIsEnabled(bool $ignoreDependencyOnSatisfiedModules) : bool
    {
        ...
        if ($this->requiresSatisfyingModule()) {
            ...
            if (!$this->satisfyingModule->calculateIsEnabled(\true)) {
                return \false;
            }
        }
