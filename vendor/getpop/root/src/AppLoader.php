...
class AppLoader implements \PoP\Root\AppLoaderInterface
{
     ...
     */
    public function addModuleClassesToInitialize(array $moduleClasses) : void
    {
     ...
     */
    public function addModuleClassConfiguration(array $moduleClassConfiguration) : void
    {
     ...
     */
    public function addSystemContainerCompilerPassClasses(array $systemContainerCompilerPassClasses) : void
    {
     ...
     */
    public function addApplicationContainerCompilerPassClasses(array $applicationContainerCompilerPassClasses) : void
    {
     ...
     */
    public function addSchemaModuleClassesToSkip(array $skipSchemaModuleClasses) : void
    {
     ...
     */
    public function initializeModules(bool $isDev = \false) : void
    {
    ...
    public function setContainerCacheConfiguration(?ContainerCacheConfiguration $containerCacheConfiguration = null) : void
    {
    ...
    public function bootApplicationModules() : void
    {
        ...
        $this->setReadyState(\true);
        // Allow to inject functionality
        \PoP\Root\App::doAction(\sprintf(HookNamePlaceholders::APPLICATION_READY_FOR_APP_THREAD, \PoP\Root\App::getAppThread()->getName() ?? ''));
        \PoP\Root\App::doAction(HookNames::APPLICATION_READY);
    }
}
