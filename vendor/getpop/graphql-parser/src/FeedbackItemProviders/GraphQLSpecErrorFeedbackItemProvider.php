...
class GraphQLSpecErrorFeedbackItemProvider extends AbstractFeedbackItemProvider
{
    ...
    public function getMessagePlaceholder(string $code) : string
    {
        return match ($code) {
            ...
            self::E_5_2_1_1 => $this->__('Operation name \'%s\' is duplicated', 'gatographql'),
            self::E_5_2_2_1 => $this->__('When the document contains more than one operation, there can be no anonymous operation', 'gatographql'),
            // self::E_5_2_3_1 => 'subscriptions_not_yet_supported',
            self::E_5_3_1 => $this->__('There is no field \'%s\' on type \'%s\'', 'gatographql'),
            self::E_5_3_2 => $this->__('The response for field \'%s\' on object with ID \'%s\' is ambiguous, as the previous (and non equivalent) field \'%s\' must also be printed under key \'%s\'', 'gatographql'),
            self::E_5_3_3 => $this->__('Field \'%s\' from type \'%s\' is not a connection', 'gatographql'),
            self::E_5_4_1_A => $this->__('On field \'%1$s\' of type \'%2$s\', there is no argument with name \'%3$s\'', 'gatographql'),
            self::E_5_4_1_B => $this->__('On directive \'%1$s\', there is no argument with name \'%2$s\'', 'gatographql'),
            self::E_5_4_2 => $this->__('Argument \'%s\' is duplicated', 'gatographql'),
            self::E_5_4_2_1_A => $this->__('Mandatory argument \'%1$s\' in field \'%2$s\' of type \'%3$s\' has not been provided', 'gatographql'),
            self::E_5_4_2_1_B => $this->__('Argument \'%1$s\' in field \'%2$s\' of type \'%3$s\' cannot be null', 'gatographql'),
            self::E_5_4_2_1_C => $this->__('Mandatory argument \'%1$s\' in directive \'%2$s\' has not been provided', 'gatographql'),
            self::E_5_4_2_1_D => $this->__('Argument \'%1$s\' in directive \'%2$s\' cannot be null', 'gatographql'),
            self::E_5_5_1_1 => $this->__('Fragment name \'%s\' is duplicated', 'gatographql'),
            self::E_5_5_1_2 => $this->__('Fragment spread type \'%s\' is not defined in the schema', 'gatographql'),
            self::E_5_5_1_3 => $this->__('The target type of fragment\'%s\' must have kind UNION, INTERFACE, or OBJECT.', 'gatographql'),
            self::E_5_5_1_4 => $this->__('Fragment \'%s\' is not used', 'gatographql'),
            self::E_5_5_2_1 => $this->__('Fragment \'%s\' is not defined in document', 'gatographql'),
            self::E_5_5_2_2 => $this->__('Fragment \'%s\' is cyclical', 'gatographql'),
            ...
            self::E_5_6_2 => $this->__('There is no input field \'%s\' in input object \'%s\'', 'gatographql'),
            self::E_5_6_3 => $this->__('Input object has duplicate key \'%s\'', 'gatographql'),
            self::E_5_6_4_A => $this->__('Mandatory input field \'%s\' in input object \'%s\' has not been provided', 'gatographql'),
            self::E_5_6_4_B => $this->__('Input field \'%s\' in input object \'%s\' cannot be null', 'gatographql'),
            self::E_5_7_1 => $this->__('There is no directive with name \'%s\'', 'gatographql'),
            self::E_5_7_2 => $this->__('Directive \'%s\' is not supported at this directive location, or for this node in the GraphQL query', 'gatographql'),
            self::E_5_7_3 => $this->__('Directive \'%s\' can be executed only once', 'gatographql'),
            self::E_5_8_1 => $this->__('Variable name \'%s\' is duplicated', 'gatographql'),
            self::E_5_8_2 => $this->__('Variable \'%s\' must be of Input type, but type \'%s\' is not (UNION, INTERFACE, or OBJECT types are not allowed)', 'gatographql'),
            self::E_5_8_3 => $this->__('Variable \'%s\' has not been defined in the operation', 'gatographql'),
            self::E_5_8_4 => $this->__('Variable \'%s\' is not used', 'gatographql'),
            self::E_5_8_5 => $this->__('Non-nullable variable \'%s\' has not been provided', 'gatographql'),
            self::E_6_1_A => $this->__('Operation with name \'%s\' does not exist', 'gatographql'),
            self::E_6_1_B => $this->__('When the document contains more than one operation, the operation name to execute must be provided', 'gatographql'),
            self::E_6_1_C => $this->__('The document is empty', 'gatographql'),
            self::E_6_1_D => $this->__('No operations defined in the document', 'gatographql'),
    ...
    public function getSpecifiedByURL(string $code) : ?string
    {
        return match ($code) {
            ...
            self::E_5_4_1_A, self::E_5_4_1_B => 'https://spec.graphql.org/draft/#sec-Argument-Names',
            self::E_5_4_2 => 'https://spec.graphql.org/draft/#sec-Argument-Uniqueness',
            self::E_5_4_2_1_A, self::E_5_4_2_1_B, self::E_5_4_2_1_C, self::E_5_4_2_1_D => 'https://spec.graphql.org/draft/#sec-Required-Arguments',
            ...
            self::E_5_6_4_A, self::E_5_6_4_B => 'https://spec.graphql.org/draft/#sec-Input-Object-Required-Fields',
            ...
            self::E_6_1_A, self::E_6_1_B, self::E_6_1_C, self::E_6_1_D => 'https://spec.graphql.org/draft/#sec-Executing-Requests',
