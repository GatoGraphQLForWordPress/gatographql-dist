...
class InputObject extends AbstractAst implements \PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\ArgumentValueAstInterface, WithAstValueInterface
{
     ...
     */
    public function isEquivalentTo(\PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\InputObject $inputObject) : bool
    {
        ...
        foreach ($thisInputObjectValueKeys as $key) {
            ...
            if ($thisInputObjectElemValue === null && $againstInputObjectElemValue !== null || $thisInputObjectElemValue !== null && $againstInputObjectElemValue === null) {
                return \false;
            }
            if (\is_object($thisInputObjectElemValue) && !\is_object($againstInputObjectElemValue) || !\is_object($thisInputObjectElemValue) && \is_object($againstInputObjectElemValue)) {
                return \false;
            }
            if (\is_object($thisInputObjectElemValue) && !$thisInputObjectElemValue instanceof stdClass) {
                 ...
                 */
                if ($thisInputObjectElemValue instanceof \PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\InputList) {
                    /** @var InputList */
                ...
                if ($thisInputObjectElemValue instanceof \PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\InputObject) {
                    /** @var InputObject */
                ...
                if ($thisInputObjectElemValue instanceof \PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\Enum) {
                    /** @var Enum */
                ...
                if ($thisInputObjectElemValue instanceof \PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\Literal) {
                    /** @var Literal */
                ...
                if ($thisInputObjectElemValue instanceof \PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\VariableReference) {
                ...
                throw new ShouldNotHappenException(\sprintf($this->__('Cannot recognize the type of the object, of class \'%s\'', 'graphql-parser'), \get_class($thisInputObjectElemValue)));
            }
            /**
