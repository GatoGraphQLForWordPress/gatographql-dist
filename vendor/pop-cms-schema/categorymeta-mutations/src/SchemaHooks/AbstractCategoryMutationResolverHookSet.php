...
abstract class AbstractCategoryMutationResolverHookSet extends AbstractHookSet
{
    ...
    {
        return $inputObjectTypeResolver instanceof CreateCategoryTermInputObjectTypeResolverInterface || $inputObjectTypeResolver instanceof UpdateCategoryTermInputObjectTypeResolverInterface;
    }
