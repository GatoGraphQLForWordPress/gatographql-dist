...
/** @internal */
abstract class AbstractMutateCategoryTermMetaMutationResolver extends AbstractMutateTaxonomyTermMetaMutationResolver implements \PoPCMSSchema\CategoryMetaMutations\MutationResolvers\CategoryTermMetaMutationResolverInterface
{
    /**
     * @var \PoPCMSSchema\CategoryMetaMutations\TypeAPIs\CategoryMetaTypeMutationAPIInterface|null
     */
    private $categoryTypeMutationAPI;
    protected final function getCategoryMetaTypeMutationAPI() : CategoryMetaTypeMutationAPIInterface
    {
    ...
    {
        App::doAction(CategoryMetaCRUDHookNames::VALIDATE_ADD_META, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    ...
    {
        App::doAction(CategoryMetaCRUDHookNames::VALIDATE_UPDATE_META, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    ...
    {
        App::doAction(CategoryMetaCRUDHookNames::VALIDATE_DELETE_META, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    ...
    {
        App::doAction(CategoryMetaCRUDHookNames::VALIDATE_SET_META, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    ...
    protected function updateMeta(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore)
    {
        ...
        App::doAction(CategoryMetaCRUDHookNames::EXECUTE_UPDATE_META, $fieldDataAccessor->getValue(MutationInputProperties::ID), $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
        return $taxonomyTermID;
    }
    /**
