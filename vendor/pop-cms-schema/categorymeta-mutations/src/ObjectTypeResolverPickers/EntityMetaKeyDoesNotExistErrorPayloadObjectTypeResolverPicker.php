...
class EntityMetaKeyDoesNotExistErrorPayloadObjectTypeResolverPicker extends AbstractEntityMetaKeyDoesNotExistErrorPayloadObjectTypeResolverPicker
{
    ...
    {
        return [AbstractRootDeleteCategoryTermMetaMutationErrorPayloadUnionTypeResolver::class, AbstractCategoryDeleteMetaMutationErrorPayloadUnionTypeResolver::class];
    }
}
