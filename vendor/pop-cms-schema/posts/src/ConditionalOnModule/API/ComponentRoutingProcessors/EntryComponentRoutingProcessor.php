...
class EntryComponentRoutingProcessor extends AbstractEntryComponentRoutingProcessor
{
    ...
    {
        $ret = array();
        $ret[CustomPostRequestNature::CUSTOMPOST][] = ['component' => new Component(FieldDataloadComponentProcessor::class, FieldDataloadComponentProcessor::COMPONENT_DATALOAD_RELATIONALFIELDS_SINGLEPOST), 'conditions' => ['scheme' => APISchemes::API]];
        return $ret;
    }
    /**
    ...
    public function getStatePropertiesToSelectComponentByNatureAndRoute() : array
    {
        ...
        $routeComponents = array($moduleConfiguration->getPostsRoute() => new Component(FieldDataloadComponentProcessor::class, FieldDataloadComponentProcessor::COMPONENT_DATALOAD_RELATIONALFIELDS_POSTLIST));
