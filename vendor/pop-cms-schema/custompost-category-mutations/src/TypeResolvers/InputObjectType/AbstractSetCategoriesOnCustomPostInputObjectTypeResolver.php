...
abstract class AbstractSetCategoriesOnCustomPostInputObjectTypeResolver extends AbstractInputObjectTypeResolver
{
    ...
    public function getInputFieldDescription(string $inputFieldName) : ?string
    {
        return match ($inputFieldName) {
            ...
            MutationInputProperties::CATEGORIES_BY => \sprintf($this->__('The categories to set, of type \'%s\'', 'gatographql'), $this->getCategoryTypeResolver()->getMaybeNamespacedTypeName()),
