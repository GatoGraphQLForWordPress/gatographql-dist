...
{
    /**
     * @var \PoPCMSSchema\TagMutations\RelationalTypeDataLoaders\ObjectType\TagDoesNotExistErrorPayloadObjectTypeDataLoader|null
     */
    private $tagDoesNotExistErrorPayloadObjectTypeDataLoader;
    public final function setTagDoesNotExistErrorPayloadObjectTypeDataLoader(TagDoesNotExistErrorPayloadObjectTypeDataLoader $tagDoesNotExistErrorPayloadObjectTypeDataLoader) : void
    {
