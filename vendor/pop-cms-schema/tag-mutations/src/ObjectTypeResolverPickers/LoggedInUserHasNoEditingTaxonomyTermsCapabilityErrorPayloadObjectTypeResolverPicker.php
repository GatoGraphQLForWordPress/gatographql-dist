...
class LoggedInUserHasNoEditingTaxonomyTermsCapabilityErrorPayloadObjectTypeResolverPicker extends AbstractLoggedInUserHasNoEditingTaxonomyTermsCapabilityErrorPayloadObjectTypeResolverPicker
{
    ...
    {
        return [AbstractTagUpdateMutationErrorPayloadUnionTypeResolver::class, AbstractRootCreateTagTermMutationErrorPayloadUnionTypeResolver::class, AbstractRootUpdateTagTermMutationErrorPayloadUnionTypeResolver::class];
    }
}
