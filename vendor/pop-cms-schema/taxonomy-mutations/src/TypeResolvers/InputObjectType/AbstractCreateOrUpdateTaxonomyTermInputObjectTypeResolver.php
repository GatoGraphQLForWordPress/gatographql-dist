...
abstract class AbstractCreateOrUpdateTaxonomyTermInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements \PoPCMSSchema\TaxonomyMutations\TypeResolvers\InputObjectType\UpdateTaxonomyTermInputObjectTypeResolverInterface, \PoPCMSSchema\TaxonomyMutations\TypeResolvers\InputObjectType\CreateTaxonomyTermInputObjectTypeResolverInterface
{
    ...
    {
        return \array_merge($this->addTaxonomyInputField() ? [MutationInputProperties::ID => $this->getIDScalarTypeResolver()] : [], $this->addParentIDInputField() ? [MutationInputProperties::PARENT_BY => $this->getTaxonomyTermParentInputObjectTypeResolver()] : [], [MutationInputProperties::NAME => $this->getStringScalarTypeResolver(), MutationInputProperties::DESCRIPTION => $this->getStringScalarTypeResolver(), MutationInputProperties::SLUG => $this->getStringScalarTypeResolver()]);
    }
