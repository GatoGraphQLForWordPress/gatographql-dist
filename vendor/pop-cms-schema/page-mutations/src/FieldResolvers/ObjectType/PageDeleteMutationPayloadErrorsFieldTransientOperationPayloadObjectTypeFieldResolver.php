...
class PageDeleteMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getPageDeleteMutationErrorPayloadUnionTypeResolver() : PageDeleteMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [PageDeleteMutationPayloadObjectTypeResolver::class];
    }
