...
class PageObjectTypeFieldResolver extends AbstractCustomPostObjectTypeFieldResolver
{
    ...
    protected final function getPageDeleteMutationPayloadObjectTypeResolver() : PageDeleteMutationPayloadObjectTypeResolver
    {
    ...
    protected final function getPageDeleteInputObjectTypeResolver() : PageDeleteInputObjectTypeResolver
    {
    ...
    public function getFieldArgNameTypeResolvers(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : array
    {
        return match ($fieldName) {
            ...
            'delete' => ['input' => $this->getPageDeleteInputObjectTypeResolver()],
    ...
    public function getFieldMutationResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ?MutationResolverInterface
    {
        ...
        return match ($fieldName) {
            ...
            'delete' => $usePayloadableCustomPostMutations ? $this->getPayloadableDeletePageMutationResolver() : $this->getDeletePageMutationResolver(),
    ...
    public function getFieldTypeResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ConcreteTypeResolverInterface
    {
        ...
        return match ($fieldName) {
            ...
            'delete' => $usePayloadableCustomPostMutations ? $this->getPageDeleteMutationPayloadObjectTypeResolver() : $this->getBooleanScalarTypeResolver(),
