...
class RootDeletePageMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getRootDeletePageMutationErrorPayloadUnionTypeResolver() : RootDeletePageMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [RootDeletePageMutationPayloadObjectTypeResolver::class];
    }
