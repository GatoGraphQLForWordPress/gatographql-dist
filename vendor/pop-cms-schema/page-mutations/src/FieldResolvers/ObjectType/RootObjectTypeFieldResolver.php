...
class RootObjectTypeFieldResolver extends AbstractObjectTypeFieldResolver
{
    ...
    protected final function getRootDeletePageMutationPayloadObjectTypeResolver() : RootDeletePageMutationPayloadObjectTypeResolver
    {
    ...
    protected final function getDeletePageMutationResolver() : DeletePageMutationResolver
    {
    ...
    protected final function getDeletePageBulkOperationMutationResolver() : DeletePageBulkOperationMutationResolver
    {
    ...
    protected final function getPayloadableDeletePageMutationResolver() : PayloadableDeletePageMutationResolver
    {
    ...
    protected final function getPayloadableDeletePageBulkOperationMutationResolver() : PayloadableDeletePageBulkOperationMutationResolver
    {
    ...
    protected final function getRootDeletePageInputObjectTypeResolver() : RootDeletePageInputObjectTypeResolver
    {
    ...
    public function getFieldNamesToResolve() : array
    {
        ...
        return \array_merge(['createPage', 'createPages'], !$disableRedundantRootTypeMutationFields ? ['updatePage', 'updatePages', 'deletePage', 'deletePages'] : [], $addFieldsToQueryPayloadableCustomPostMutations ? ['createPageMutationPayloadObjects'] : [], $addFieldsToQueryPayloadableCustomPostMutations && !$disableRedundantRootTypeMutationFields ? ['updatePageMutationPayloadObjects', 'deletePageMutationPayloadObjects'] : []);
    }
    ...
    public function getFieldTypeModifiers(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : int
    {
        ...
        if (!$usePayloadableCustomPostMutations) {
            return match ($fieldName) {
                'createPage', 'updatePage' => SchemaTypeModifiers::NONE,
                'deletePage' => SchemaTypeModifiers::NON_NULLABLE,
                'createPages', 'updatePages' => SchemaTypeModifiers::NON_NULLABLE | SchemaTypeModifiers::IS_ARRAY,
                'deletePages' => SchemaTypeModifiers::NON_NULLABLE | SchemaTypeModifiers::IS_ARRAY | SchemaTypeModifiers::IS_NON_NULLABLE_ITEMS_IN_ARRAY,
                default => parent::getFieldTypeModifiers($objectTypeResolver, $fieldName),
            };
        }
        if (\in_array($fieldName, ['createPageMutationPayloadObjects', 'updatePageMutationPayloadObjects', 'deletePageMutationPayloadObjects'])) {
            return $this->getMutationPayloadObjectsFieldTypeModifiers();
        }
        return match ($fieldName) {
            'createPage', 'updatePage', 'deletePage' => SchemaTypeModifiers::NON_NULLABLE,
            'createPages', 'updatePages', 'deletePages' => SchemaTypeModifiers::NON_NULLABLE | SchemaTypeModifiers::IS_ARRAY | SchemaTypeModifiers::IS_NON_NULLABLE_ITEMS_IN_ARRAY,
            default => parent::getFieldTypeModifiers($objectTypeResolver, $fieldName),
        };
    }
    /**
    ...
    {
        return match ($fieldName) {
            'createPage' => ['input' => $this->getRootCreatePageInputObjectTypeResolver()],
            'createPages' => $this->getBulkOperationFieldArgNameTypeResolvers($this->getRootCreatePageInputObjectTypeResolver()),
            'updatePage' => ['input' => $this->getRootUpdatePageInputObjectTypeResolver()],
            'updatePages' => $this->getBulkOperationFieldArgNameTypeResolvers($this->getRootUpdatePageInputObjectTypeResolver()),
            'deletePage' => ['input' => $this->getRootDeletePageInputObjectTypeResolver()],
            'deletePages' => $this->getBulkOperationFieldArgNameTypeResolvers($this->getRootDeletePageInputObjectTypeResolver()),
            'createPageMutationPayloadObjects', 'updatePageMutationPayloadObjects', 'deletePageMutationPayloadObjects' => $this->getMutationPayloadObjectsFieldArgNameTypeResolvers(),
    ...
    public function getFieldArgTypeModifiers(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName, string $fieldArgName) : int
    {
        ...
        if (\in_array($fieldName, ['createPages', 'updatePages', 'deletePages'])) {
        ...
        return match ([$fieldName => $fieldArgName]) {
            ['createPage' => 'input'], ['updatePage' => 'input'], ['deletePage' => 'input'] => SchemaTypeModifiers::MANDATORY,
    ...
    public function getFieldMutationResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ?MutationResolverInterface
    {
        ...
        $usePayloadableCustomPostMutations = $moduleConfiguration->usePayloadableCustomPostMutations();
        return match ($fieldName) {
            'createPage' => $usePayloadableCustomPostMutations ? $this->getPayloadableCreatePageMutationResolver() : $this->getCreatePageMutationResolver(),
            'createPages' => $usePayloadableCustomPostMutations ? $this->getPayloadableCreatePageBulkOperationMutationResolver() : $this->getCreatePageBulkOperationMutationResolver(),
            'updatePage' => $usePayloadableCustomPostMutations ? $this->getPayloadableUpdatePageMutationResolver() : $this->getUpdatePageMutationResolver(),
            'updatePages' => $usePayloadableCustomPostMutations ? $this->getPayloadableUpdatePageBulkOperationMutationResolver() : $this->getUpdatePageBulkOperationMutationResolver(),
            'deletePage' => $usePayloadableCustomPostMutations ? $this->getPayloadableDeletePageMutationResolver() : $this->getDeletePageMutationResolver(),
            'deletePages' => $usePayloadableCustomPostMutations ? $this->getPayloadableDeletePageBulkOperationMutationResolver() : $this->getDeletePageBulkOperationMutationResolver(),
    ...
    public function getFieldTypeResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ConcreteTypeResolverInterface
    {
        ...
        if ($usePayloadableCustomPostMutations) {
            return match ($fieldName) {
                'createPage', 'createPages', 'createPageMutationPayloadObjects' => $this->getRootCreatePageMutationPayloadObjectTypeResolver(),
                'updatePage', 'updatePages', 'updatePageMutationPayloadObjects' => $this->getRootUpdatePageMutationPayloadObjectTypeResolver(),
                'deletePage', 'deletePages', 'deletePageMutationPayloadObjects' => $this->getRootDeletePageMutationPayloadObjectTypeResolver(),
                default => parent::getFieldTypeResolver($objectTypeResolver, $fieldName),
            };
        }
        return match ($fieldName) {
            'createPage', 'createPages', 'updatePage', 'updatePages' => $this->getPageObjectTypeResolver(),
            'deletePage', 'deletePages' => $this->getBooleanScalarTypeResolver(),
            default => parent::getFieldTypeResolver($objectTypeResolver, $fieldName),
        };
    }
    /**
