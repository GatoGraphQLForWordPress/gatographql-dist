...
trait PageMutationResolverHookSetTrait
{
    ...
    {
        return $inputObjectTypeResolver instanceof CreatePageInputObjectTypeResolverInterface || $inputObjectTypeResolver instanceof UpdatePageInputObjectTypeResolverInterface;
    }
}
