...
interface CommentTypeMutationAPIInterface
{
     ...
     * @param array<string,mixed> $comment_data
     */
    public function updateComment(string|int $commentID, array $comment_data) : void;
    /**
     ...
     * @throws CommentCRUDMutationException In case of error
     */
    public function setCommentStatus(string|int $commentID, string $commentStatus) : void;
    /**
     * @throws CommentCRUDMutationException In case of error
     */
    public function trashComment(string|int $commentID) : void;
    /**
     * @throws CommentCRUDMutationException In case of error
     */
    public function deleteComment(string|int $commentID) : void;
    /**
     * Whether comments can be sent to the trash, or must always
     * be deleted permanently.
     */
    public function doesCommentSupportTrash() : bool;
    public function isCommentInTrash(string|int $commentID) : bool;
    /**
     ...
     */
    public function canUserEditComment(string|int $userID, string|int $commentID) : bool;
}
