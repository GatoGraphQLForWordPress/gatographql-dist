...
class UserIsNotLoggedInErrorPayloadObjectTypeResolverPicker extends AbstractUserIsNotLoggedInErrorPayloadObjectTypeResolverPicker
{
    ...
    public function getUnionTypeResolverClassesToAttachTo() : array
    {
        ...
        return \array_merge(
             ...
             */
            [AbstractUpdateCommentMutationErrorPayloadUnionTypeResolver::class, AbstractDeleteCommentMutationErrorPayloadUnionTypeResolver::class],
            $moduleConfiguration->mustUserBeLoggedInToAddComment() ? [AbstractCommentMutationErrorPayloadUnionTypeResolver::class] : []
        );
    }
}
