...
abstract class AbstractLoggedInUserHasNoPermissionToDeleteCommentErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteCommentErrorPayloadObjectTypeResolver() : LoggedInUserHasNoPermissionToDeleteCommentErrorPayloadObjectTypeResolver
    {
