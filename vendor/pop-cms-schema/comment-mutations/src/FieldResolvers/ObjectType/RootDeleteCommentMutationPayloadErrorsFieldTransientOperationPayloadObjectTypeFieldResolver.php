...
class RootDeleteCommentMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getRootDeleteCommentMutationErrorPayloadUnionTypeResolver() : RootDeleteCommentMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [RootDeleteCommentMutationPayloadObjectTypeResolver::class];
    }
