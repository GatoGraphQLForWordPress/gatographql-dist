...
class CommentUpdateMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getCommentUpdateMutationErrorPayloadUnionTypeResolver() : CommentUpdateMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [CommentUpdateMutationPayloadObjectTypeResolver::class];
    }
