...
/** @internal */
class CommentDeleteMutationErrorPayloadUnionTypeResolver extends \PoPCMSSchema\CommentMutations\TypeResolvers\UnionType\AbstractDeleteCommentMutationErrorPayloadUnionTypeResolver
{
    private ?CommentDeleteMutationErrorPayloadUnionTypeDataLoader $commentDeleteMutationErrorPayloadUnionTypeDataLoader = null;
    protected final function getCommentDeleteMutationErrorPayloadUnionTypeDataLoader() : CommentDeleteMutationErrorPayloadUnionTypeDataLoader
    {
