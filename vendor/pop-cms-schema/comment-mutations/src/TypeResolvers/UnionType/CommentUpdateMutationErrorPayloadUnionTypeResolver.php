...
/** @internal */
class CommentUpdateMutationErrorPayloadUnionTypeResolver extends \PoPCMSSchema\CommentMutations\TypeResolvers\UnionType\AbstractUpdateCommentMutationErrorPayloadUnionTypeResolver
{
    private ?CommentUpdateMutationErrorPayloadUnionTypeDataLoader $commentUpdateMutationErrorPayloadUnionTypeDataLoader = null;
    protected final function getCommentUpdateMutationErrorPayloadUnionTypeDataLoader() : CommentUpdateMutationErrorPayloadUnionTypeDataLoader
    {
