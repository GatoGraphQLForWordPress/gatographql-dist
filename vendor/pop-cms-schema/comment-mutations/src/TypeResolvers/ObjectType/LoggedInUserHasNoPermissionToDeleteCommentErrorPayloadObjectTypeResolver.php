...
class LoggedInUserHasNoPermissionToDeleteCommentErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteCommentErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoPermissionToDeleteCommentErrorPayloadObjectTypeDataLoader
    {
