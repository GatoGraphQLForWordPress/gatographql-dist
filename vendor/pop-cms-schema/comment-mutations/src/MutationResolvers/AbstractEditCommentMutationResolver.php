...
abstract class AbstractEditCommentMutationResolver extends AbstractMutationResolver
{
     ...
     */
    protected function validateCommentExists(string|int|null $commentID, FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
     ...
     */
    protected function validateCanLoggedInUserEditComment(string|int $commentID, string $errorCode, FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        $userID = App::getState('current-user-id');
        if ($this->getCommentTypeMutationAPI()->canUserEditComment($userID, $commentID)) {
            return;
        }
        $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, $errorCode, [$commentID]), $fieldDataAccessor->getField()));
    }
