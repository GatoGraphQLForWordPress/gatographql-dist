...
{
    use PayloadableMutationResolverTrait, \PoPCMSSchema\CommentMutations\MutationResolvers\UpdateCommentMutationResolverTrait {
        \PoPCMSSchema\CommentMutations\MutationResolvers\UpdateCommentMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof \PoPCMSSchema\CommentMutations\MutationResolvers\UpdateCommentMutationResolverTrait;
    }
    ...
    protected function createErrorPayloadFromObjectTypeFieldResolutionFeedback(ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback) : ErrorPayloadInterface
    {
        ...
        return App::applyFilters(CommentCRUDHookNames::ERROR_PAYLOAD, $this->createEditCommentErrorPayloadFromObjectTypeFieldResolutionFeedback($objectTypeFieldResolutionFeedback) ?? $this->createUpdateCommentErrorPayloadFromObjectTypeFieldResolutionFeedback($objectTypeFieldResolutionFeedback) ?? new GenericErrorPayload($feedbackItemResolution->getMessage(), $feedbackItemResolution->getNamespacedCode()), $objectTypeFieldResolutionFeedback);
    }
    protected function createUpdateCommentErrorPayloadFromObjectTypeFieldResolutionFeedback(ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback) : ?ErrorPayloadInterface
    {
        $feedbackItemResolution = $objectTypeFieldResolutionFeedback->getFeedbackItemResolution();
