...
{
    use PayloadableMutationResolverTrait, \PoPCMSSchema\CommentMutations\MutationResolvers\DeleteCommentMutationResolverTrait {
        \PoPCMSSchema\CommentMutations\MutationResolvers\DeleteCommentMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof \PoPCMSSchema\CommentMutations\MutationResolvers\DeleteCommentMutationResolverTrait;
    }
    /**
    ...
    protected function createErrorPayloadFromObjectTypeFieldResolutionFeedback(ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback) : ErrorPayloadInterface
    {
        ...
        return match ([$feedbackItemResolution->getFeedbackProviderServiceClass(), $feedbackItemResolution->getCode()]) {
            ...
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E12] => new LoggedInUserHasNoPermissionToDeleteCommentErrorPayload($feedbackItemResolution->getMessage()),
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E13] => new CommentDoesNotSupportTrashErrorPayload($feedbackItemResolution->getMessage()),
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E14] => new CommentHasAlreadyBeenTrashedErrorPayload($feedbackItemResolution->getMessage()),
