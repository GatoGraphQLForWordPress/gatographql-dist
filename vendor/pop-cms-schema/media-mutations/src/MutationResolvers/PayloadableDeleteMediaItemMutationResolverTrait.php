...
{
    use PayloadableMutationResolverTrait, \PoPCMSSchema\MediaMutations\MutationResolvers\DeleteMediaItemMutationResolverTrait {
        \PoPCMSSchema\MediaMutations\MutationResolvers\DeleteMediaItemMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof \PoPCMSSchema\MediaMutations\MutationResolvers\DeleteMediaItemMutationResolverTrait;
    }
    /**
    ...
    protected function createErrorPayloadFromObjectTypeFieldResolutionFeedback(ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback) : ErrorPayloadInterface
    {
        ...
        return match ([$feedbackItemResolution->getFeedbackProviderServiceClass(), $feedbackItemResolution->getCode()]) {
            ...
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E10] => new UserIsNotLoggedInErrorPayload($feedbackItemResolution->getMessage()),
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E11] => new LoggedInUserHasNoPermissionToDeleteMediaItemErrorPayload($feedbackItemResolution->getMessage()),
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E12] => new MediaItemDoesNotSupportTrashErrorPayload($feedbackItemResolution->getMessage()),
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E13] => new MediaItemHasAlreadyBeenTrashedErrorPayload($feedbackItemResolution->getMessage()),
