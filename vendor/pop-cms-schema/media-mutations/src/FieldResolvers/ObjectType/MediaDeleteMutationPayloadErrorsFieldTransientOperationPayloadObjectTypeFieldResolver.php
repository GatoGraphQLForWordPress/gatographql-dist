...
class MediaDeleteMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getMediaDeleteMutationErrorPayloadUnionTypeResolver() : MediaDeleteMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [MediaDeleteMutationPayloadObjectTypeResolver::class];
    }
