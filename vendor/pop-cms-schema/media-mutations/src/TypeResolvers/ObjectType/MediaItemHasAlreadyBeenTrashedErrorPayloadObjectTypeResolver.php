...
class MediaItemHasAlreadyBeenTrashedErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getMediaItemHasAlreadyBeenTrashedErrorPayloadObjectTypeDataLoader() : MediaItemHasAlreadyBeenTrashedErrorPayloadObjectTypeDataLoader
    {
