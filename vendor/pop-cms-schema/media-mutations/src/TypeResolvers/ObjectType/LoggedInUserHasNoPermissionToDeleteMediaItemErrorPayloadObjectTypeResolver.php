...
class LoggedInUserHasNoPermissionToDeleteMediaItemErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteMediaItemErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoPermissionToDeleteMediaItemErrorPayloadObjectTypeDataLoader
    {
