...
abstract class AbstractUpdateMediaItemInputObjectTypeResolver extends \PoPCMSSchema\MediaMutations\TypeResolvers\InputObjectType\AbstractCreateOrUpdateMediaItemInputObjectTypeResolver implements \PoPCMSSchema\MediaMutations\TypeResolvers\InputObjectType\UpdateMediaItemInputObjectTypeResolverInterface
{
    ...
    {
        return App::applyFilters(HookNames::UPDATE_MEDIA_ITEM_INPUT_FIELD_NAME_TYPE_RESOLVERS, parent::getInputFieldNameTypeResolvers(), $this);
    }
    public function getInputFieldDescription(string $inputFieldName) : ?string
    {
        return App::applyFilters(HookNames::UPDATE_MEDIA_ITEM_INPUT_FIELD_DESCRIPTION, parent::getInputFieldDescription($inputFieldName), $inputFieldName, $this);
    }
    public function getInputFieldTypeModifiers(string $inputFieldName) : int
    {
        return App::applyFilters(HookNames::UPDATE_MEDIA_ITEM_INPUT_FIELD_TYPE_MODIFIERS, parent::getInputFieldTypeModifiers($inputFieldName), $inputFieldName, $this);
    }
}
