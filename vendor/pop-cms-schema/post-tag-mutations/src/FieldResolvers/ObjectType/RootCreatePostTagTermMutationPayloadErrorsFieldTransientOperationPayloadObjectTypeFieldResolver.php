...
class RootCreatePostTagTermMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    public final function setRootCreatePostTagTermMutationErrorPayloadUnionTypeResolver(RootCreatePostTagTermMutationErrorPayloadUnionTypeResolver $rootCreatePostTagTermMutationErrorPayloadUnionTypeResolver) : void
    {
    ...
    {
        return [RootCreatePostTagTermMutationPayloadObjectTypeResolver::class];
    }
