...
{
    use PayloadableMutationResolverTrait, \PoPCMSSchema\MenuMutations\MutationResolvers\DeleteMenuMutationResolverTrait {
        \PoPCMSSchema\MenuMutations\MutationResolvers\DeleteMenuMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof \PoPCMSSchema\MenuMutations\MutationResolvers\DeleteMenuMutationResolverTrait;
    }
    /**
    ...
    public function executeMutation(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : mixed
    {
        ...
        try {
            ...
            return $this->createFailureObjectMutationPayload([$this->createGenericErrorPayloadFromPayloadClientException($menuCRUDMutationException)])->getID();
        }
    ...
    protected function createErrorPayloadFromObjectTypeFieldResolutionFeedback(ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback) : ErrorPayloadInterface
    {
        ...
        return match ([$feedbackItemResolution->getFeedbackProviderServiceClass(), $feedbackItemResolution->getCode()]) {
            ...
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E11] => new LoggedInUserHasNoPermissionToDeleteMenuErrorPayload($feedbackItemResolution->getMessage()),
