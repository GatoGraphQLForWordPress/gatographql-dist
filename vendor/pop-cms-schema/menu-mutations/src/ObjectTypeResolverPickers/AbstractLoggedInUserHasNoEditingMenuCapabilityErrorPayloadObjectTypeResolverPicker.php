...
abstract class AbstractLoggedInUserHasNoEditingMenuCapabilityErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getLoggedInUserHasNoEditingMenuCapabilityErrorPayloadObjectTypeResolver() : LoggedInUserHasNoEditingMenuCapabilityErrorPayloadObjectTypeResolver
    {
