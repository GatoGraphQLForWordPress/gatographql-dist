...
abstract class AbstractUserHasNoPermissionToCreateMenusErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getUserHasNoPermissionToCreateMenusErrorPayloadObjectTypeResolver() : UserHasNoPermissionToCreateMenusErrorPayloadObjectTypeResolver
    {
