...
abstract class AbstractLoggedInUserHasNoPermissionToDeleteMenuErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteMenuErrorPayloadObjectTypeResolver() : LoggedInUserHasNoPermissionToDeleteMenuErrorPayloadObjectTypeResolver
    {
