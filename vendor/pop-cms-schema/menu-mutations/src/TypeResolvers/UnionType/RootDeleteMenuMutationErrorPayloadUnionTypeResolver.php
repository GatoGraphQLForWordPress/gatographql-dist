...
/** @internal */
class RootDeleteMenuMutationErrorPayloadUnionTypeResolver extends \PoPCMSSchema\MenuMutations\TypeResolvers\UnionType\AbstractDeleteMenuMutationErrorPayloadUnionTypeResolver
{
    private ?RootDeleteMenuMutationErrorPayloadUnionTypeDataLoader $rootDeleteMenuMutationErrorPayloadUnionTypeDataLoader = null;
    protected final function getRootDeleteMenuMutationErrorPayloadUnionTypeDataLoader() : RootDeleteMenuMutationErrorPayloadUnionTypeDataLoader
    {
