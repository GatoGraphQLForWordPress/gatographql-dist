...
class LoggedInUserHasNoEditingMenuCapabilityErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoEditingMenuCapabilityErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoEditingMenuCapabilityErrorPayloadObjectTypeDataLoader
    {
    ...
    {
        return $this->__('Error payload for: "The user cannot edit menus"', 'gatographql');
    }
