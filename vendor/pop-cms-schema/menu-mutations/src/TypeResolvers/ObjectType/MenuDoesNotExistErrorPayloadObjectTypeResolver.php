...
class MenuDoesNotExistErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getMenuDoesNotExistErrorPayloadObjectTypeDataLoader() : MenuDoesNotExistErrorPayloadObjectTypeDataLoader
    {
    ...
    {
        return $this->__('Error payload for: "The requested menu does not exist"', 'gatographql');
    }
