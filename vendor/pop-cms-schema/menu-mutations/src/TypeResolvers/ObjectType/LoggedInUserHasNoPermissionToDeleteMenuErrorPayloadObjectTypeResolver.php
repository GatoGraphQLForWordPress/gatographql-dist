...
class LoggedInUserHasNoPermissionToDeleteMenuErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteMenuErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoPermissionToDeleteMenuErrorPayloadObjectTypeDataLoader
    {
