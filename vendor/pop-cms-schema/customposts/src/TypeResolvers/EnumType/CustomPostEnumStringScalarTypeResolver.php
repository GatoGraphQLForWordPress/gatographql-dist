...
class CustomPostEnumStringScalarTypeResolver extends AbstractEnumStringScalarTypeResolver
{
    ...
    {
        return \sprintf($this->__('Custom post types (available for querying via the API), with possible values: `"%s"`.', 'customposts'), \implode('"`, `"', $this->getConsolidatedPossibleValues()));
    }
    /**
     * @return string[]
     */
