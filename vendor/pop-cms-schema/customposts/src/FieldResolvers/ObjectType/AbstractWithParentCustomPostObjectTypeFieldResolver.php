...
abstract class AbstractWithParentCustomPostObjectTypeFieldResolver extends AbstractQueryableObjectTypeFieldResolver
{
    ...
    protected final function getWithParentCustomPostChildrenFilterInputObjectTypeResolver() : WithParentCustomPostChildrenFilterInputObjectTypeResolver
    {
    ...
    {
        return ['parent', 'ancestors', 'children', 'childCount'];
    }
    public function getFieldTypeResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ConcreteTypeResolverInterface
    {
        return match ($fieldName) {
            'parent', 'ancestors', 'children' => $this->getCustomPostFieldTypeResolver(),
            'childCount' => $this->getIntScalarTypeResolver(),
            default => parent::getFieldTypeResolver($objectTypeResolver, $fieldName),
        };
    }
    protected abstract function getCustomPostFieldTypeResolver() : ConcreteTypeResolverInterface;
    ...
    public function getFieldArgNameTypeResolvers(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : array
    {
        ...
        return match ($fieldName) {
            'children' => \array_merge($fieldArgNameTypeResolvers, ['filter' => $this->getWithParentCustomPostChildrenFilterInputObjectTypeResolver(), 'pagination' => $this->getCustomPostPaginationInputObjectTypeResolver(), 'sort' => $this->getCustomPostSortInputObjectTypeResolver()]),
            'childCount' => \array_merge($fieldArgNameTypeResolvers, ['filter' => $this->getWithParentCustomPostChildrenFilterInputObjectTypeResolver()]),
    ...
    public function resolveValue(ObjectTypeResolverInterface $objectTypeResolver, object $object, FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : mixed
    {
        ...
        $query = \array_merge($this->convertFieldArgsToFilteringQueryArgs($objectTypeResolver, $fieldDataAccessor), ['parent-id' => $objectTypeResolver->getID($customPost)]);
        switch ($fieldDataAccessor->getFieldName()) {
            case 'children':
