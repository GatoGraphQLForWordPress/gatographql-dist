...
class AccessToMetaKeyIsNotAllowedErrorPayloadObjectTypeResolverPicker extends AbstractAccessToMetaKeyIsNotAllowedErrorPayloadObjectTypeResolverPicker
{
    ...
    {
        return [RootCreatePageMutationErrorPayloadUnionTypeResolver::class, RootUpdatePageMutationErrorPayloadUnionTypeResolver::class, PageUpdateMutationErrorPayloadUnionTypeResolver::class];
    }
}
