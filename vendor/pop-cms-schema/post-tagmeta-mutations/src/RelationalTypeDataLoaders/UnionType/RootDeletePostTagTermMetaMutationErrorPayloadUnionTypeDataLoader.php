...
{
    /**
     * @var \PoPCMSSchema\PostTagMetaMutations\TypeResolvers\UnionType\RootDeletePostTagTermMetaMutationErrorPayloadUnionTypeResolver|null
     */
    private $rootDeletePostTagTermMetaMutationErrorPayloadUnionTypeResolver;
