...
{
    /**
     * @var \PoPCMSSchema\UserMetaMutations\RelationalTypeDataLoaders\UnionType\RootAddUserMetaMutationErrorPayloadUnionTypeDataLoader|null
     */
    private $rootAddUserMetaMutationErrorPayloadUnionTypeDataLoader;
