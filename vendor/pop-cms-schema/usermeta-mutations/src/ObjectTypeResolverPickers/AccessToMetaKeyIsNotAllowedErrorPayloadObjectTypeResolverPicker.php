...
class AccessToMetaKeyIsNotAllowedErrorPayloadObjectTypeResolverPicker extends AbstractAccessToMetaKeyIsNotAllowedErrorPayloadObjectTypeResolverPicker
{
    ...
    {
        return [AbstractUserMetaMutationErrorPayloadUnionTypeResolver::class, RootCreateUserMutationErrorPayloadUnionTypeResolver::class, RootUpdateUserMutationErrorPayloadUnionTypeResolver::class, UserUpdateMutationErrorPayloadUnionTypeResolver::class];
    }
}
