...
use stdClass;
/** @internal */
abstract class AbstractMutateEntityMetaMutationResolver extends AbstractMutationResolver implements \PoPCMSSchema\MetaMutations\MutationResolvers\EntityMetaMutationResolverInterface
{
    ...
    protected function validateSetMetaErrors(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        $this->validateCommonMetaErrors($fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    ...
    protected function validateAddMetaErrors(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        $this->validateAreMetaKeysAllowed([$key], $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
        /** @var bool */
        ...
        if ($single) {
            ...
            /** @var string */
            $key = $fieldDataAccessor->getValue(MutationInputProperties::KEY);
            $this->validateSingleMetaEntryDoesNotExist($entityID, $key, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
        }
    }
    protected function validateCommonMetaErrors(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        $errorCount = $objectTypeFieldResolutionFeedbackStore->getErrorCount();
        $entityID = $fieldDataAccessor->getValue(MutationInputProperties::ID);
        $this->validateEntityExists($entityID, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    ...
    protected function validateUpdateMetaErrors(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        $this->validateMetaEntryDoesNotHaveValue($entityID, $key, $value, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
        if ($objectTypeFieldResolutionFeedbackStore->getErrorCount() > $errorCount) {
            return;
        }
        $prevValue = $fieldDataAccessor->getValue(MutationInputProperties::PREV_VALUE);
        if (!empty($prevValue)) {
            $this->validateMetaEntryWithValueExists($entityID, $key, $prevValue, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
        }
    }
    protected function validateDeleteMetaErrors(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        $entityID = $fieldDataAccessor->getValue(MutationInputProperties::ID);
        $this->validateMetaEntryExists($entityID, $key, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    }
    /**
    ...
    {
        return ['entries' => (array) $fieldDataAccessor->getValue(MutationInputProperties::ENTRIES)];
    }
    /**
     * @return array<string,mixed>
     */
    ...
    {
        return ['key' => $fieldDataAccessor->getValue(MutationInputProperties::KEY), 'value' => $fieldDataAccessor->getValue(MutationInputProperties::VALUE), 'single' => $fieldDataAccessor->getValue(MutationInputProperties::SINGLE) ?? \false];
    }
    /**
     * @return array<string,mixed>
     */
    ...
    {
        return ['key' => $fieldDataAccessor->getValue(MutationInputProperties::KEY), 'value' => $fieldDataAccessor->getValue(MutationInputProperties::VALUE), 'prevValue' => $fieldDataAccessor->getValue(MutationInputProperties::PREV_VALUE)];
    }
    /**
     * @return array<string,mixed>
     */
    ...
    {
        return ['key' => $fieldDataAccessor->getValue(MutationInputProperties::KEY), 'value' => $fieldDataAccessor->getValue(MutationInputProperties::VALUE)];
    }
    /**
