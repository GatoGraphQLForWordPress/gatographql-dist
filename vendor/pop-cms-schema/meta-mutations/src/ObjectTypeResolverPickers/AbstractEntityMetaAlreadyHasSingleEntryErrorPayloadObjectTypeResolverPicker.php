...
{
    /**
     * @var \PoPCMSSchema\MetaMutations\TypeResolvers\ObjectType\EntityMetaAlreadyHasSingleEntryErrorPayloadObjectTypeResolver|null
     */
    private $entityMetaAlreadyHasSingleEntryErrorPayloadObjectTypeResolver;
