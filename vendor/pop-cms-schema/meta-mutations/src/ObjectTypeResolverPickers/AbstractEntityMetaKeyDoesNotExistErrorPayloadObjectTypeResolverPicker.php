...
{
    /**
     * @var \PoPCMSSchema\MetaMutations\TypeResolvers\ObjectType\EntityMetaKeyDoesNotExistErrorPayloadObjectTypeResolver|null
     */
    private $entityMetaKeyDoesNotExistErrorPayloadObjectTypeResolver;
