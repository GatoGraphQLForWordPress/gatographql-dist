...
class Module extends AbstractModule
{
    ...
    {
        return [APIModule::class, RESTAPIModule::class, CustomPostsModule::class];
    }
    /**
     * Initialize services
     *
    ...
    protected function initializeContainerServices(bool $skipSchema, array $skipSchemaModuleClasses) : void
    {
        ...
        try {
            if (\class_exists(CustomPostsModule::class) && App::getModule(CustomPostsModule::class)->isEnabled()) {
                ...
                $this->initSchemaServices(\dirname(__DIR__), $skipSchema || \in_array(CustomPostsModule::class, $skipSchemaModuleClasses), '/ConditionalOnModule/CustomPosts');
                try {
                    if (\class_exists(APIModule::class) && App::getModule(APIModule::class)->isEnabled()) {
