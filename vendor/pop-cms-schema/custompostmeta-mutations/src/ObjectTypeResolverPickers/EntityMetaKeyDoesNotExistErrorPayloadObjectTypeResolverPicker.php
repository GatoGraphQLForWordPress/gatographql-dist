...
class EntityMetaKeyDoesNotExistErrorPayloadObjectTypeResolverPicker extends AbstractEntityMetaKeyDoesNotExistErrorPayloadObjectTypeResolverPicker
{
    ...
    {
        return [AbstractRootDeleteCustomPostMetaMutationErrorPayloadUnionTypeResolver::class, AbstractCustomPostDeleteMetaMutationErrorPayloadUnionTypeResolver::class];
    }
}
