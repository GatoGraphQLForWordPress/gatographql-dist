...
abstract class AbstractCommentObjectTypeFieldResolver extends AbstractObjectTypeFieldResolver
{
    ...
    protected final function getCommentAddMetaInputObjectTypeResolver() : CommentAddMetaInputObjectTypeResolver
    {
    ...
    protected final function getCommentDeleteMetaInputObjectTypeResolver() : CommentDeleteMetaInputObjectTypeResolver
    {
    ...
    protected final function getCommentSetMetaInputObjectTypeResolver() : CommentSetMetaInputObjectTypeResolver
    {
    ...
    protected final function getCommentUpdateMetaInputObjectTypeResolver() : CommentUpdateMetaInputObjectTypeResolver
    {
    ...
    public function getFieldDescription(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ?string
    {
        return match ($fieldName) {
            'addMeta' => $this->__('Add a comment meta entry', 'gatographql'),
            'deleteMeta' => $this->__('Delete a comment meta entry', 'gatographql'),
            'setMeta' => $this->__('Set meta entries to a comment', 'gatographql'),
            'updateMeta' => $this->__('Update a comment meta entry', 'gatographql'),
