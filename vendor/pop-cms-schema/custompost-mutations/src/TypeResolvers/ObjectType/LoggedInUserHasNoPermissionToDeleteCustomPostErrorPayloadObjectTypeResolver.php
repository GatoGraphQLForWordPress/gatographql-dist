...
class LoggedInUserHasNoPermissionToDeleteCustomPostErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteCustomPostErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoPermissionToDeleteCustomPostErrorPayloadObjectTypeDataLoader
    {
