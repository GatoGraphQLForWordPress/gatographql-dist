...
class CustomPostHasAlreadyBeenTrashedErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getCustomPostHasAlreadyBeenTrashedErrorPayloadObjectTypeDataLoader() : CustomPostHasAlreadyBeenTrashedErrorPayloadObjectTypeDataLoader
    {
