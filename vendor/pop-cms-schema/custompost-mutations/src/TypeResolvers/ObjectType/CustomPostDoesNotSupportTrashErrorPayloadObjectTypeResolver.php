...
class CustomPostDoesNotSupportTrashErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getCustomPostDoesNotSupportTrashErrorPayloadObjectTypeDataLoader() : CustomPostDoesNotSupportTrashErrorPayloadObjectTypeDataLoader
    {
