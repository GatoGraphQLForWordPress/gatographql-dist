...
trait GenericCustomPostMutationResolverHookSetTrait
{
    ...
    {
        return $inputObjectTypeResolver instanceof CreateGenericCustomPostInputObjectTypeResolverInterface || $inputObjectTypeResolver instanceof UpdateGenericCustomPostInputObjectTypeResolverInterface;
    }
}
