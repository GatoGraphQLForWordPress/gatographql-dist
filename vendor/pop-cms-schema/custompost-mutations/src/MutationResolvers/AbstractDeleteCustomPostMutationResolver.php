...
{
    use \PoPCMSSchema\CustomPostMutations\MutationResolvers\DeleteCustomPostMutationResolverTrait;
    ...
    {
        return new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E13);
    }
     ...
     */
    protected function validateIsCustomPostType(string|int $customPostID, string $customPostType, FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
     ...
     */
    protected function validateCanLoggedInUserDeleteCustomPost(string|int $customPostID, FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        $userID = App::getState('current-user-id');
        if ($this->getCustomPostTypeMutationAPI()->canUserDeleteCustomPost($userID, $customPostID)) {
            return;
        }
        $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E14, [$customPostID]), $fieldDataAccessor->getField()));
    }
    /**
     * When not deleting permanently, the custom post must support being
     * sent to the trash, and must not be in the trash already.
     */
    protected function validateCanCustomPostBeTrashed(string|int $customPostID, FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        if (!$this->getCustomPostTypeMutationAPI()->doesCustomPostTypeSupportTrash($customPostType)) {
            $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E16, [$customPostID]), $fieldDataAccessor->getField()));
            return;
        }
        if ($this->getCustomPostTypeAPI()->getStatus($customPostID) === CustomPostStatus::TRASH) {
            $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E17, [$customPostID]), $fieldDataAccessor->getField()));
        }
    }
