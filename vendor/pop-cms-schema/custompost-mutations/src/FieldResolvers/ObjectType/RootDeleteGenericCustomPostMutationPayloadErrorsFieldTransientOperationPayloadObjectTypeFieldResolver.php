...
class RootDeleteGenericCustomPostMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getRootDeleteGenericCustomPostMutationErrorPayloadUnionTypeResolver() : RootDeleteGenericCustomPostMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [RootDeleteGenericCustomPostMutationPayloadObjectTypeResolver::class];
    }
