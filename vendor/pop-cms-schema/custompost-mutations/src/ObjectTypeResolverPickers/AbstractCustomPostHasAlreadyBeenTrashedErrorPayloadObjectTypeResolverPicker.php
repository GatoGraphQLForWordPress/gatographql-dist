...
abstract class AbstractCustomPostHasAlreadyBeenTrashedErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getCustomPostHasAlreadyBeenTrashedErrorPayloadObjectTypeResolver() : CustomPostHasAlreadyBeenTrashedErrorPayloadObjectTypeResolver
    {
