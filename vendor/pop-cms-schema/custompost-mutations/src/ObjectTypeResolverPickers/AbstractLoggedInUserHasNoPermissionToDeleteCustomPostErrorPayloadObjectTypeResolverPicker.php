...
abstract class AbstractLoggedInUserHasNoPermissionToDeleteCustomPostErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteCustomPostErrorPayloadObjectTypeResolver() : LoggedInUserHasNoPermissionToDeleteCustomPostErrorPayloadObjectTypeResolver
    {
