...
class LoggedInUserHasNoEditingTaxonomyTermsCapabilityMutationErrorPayloadObjectTypeResolverPicker extends AbstractLoggedInUserHasNoEditingTaxonomyTermsCapabilityErrorPayloadObjectTypeResolverPicker
{
    ...
    {
        return [AbstractCategoryUpdateMutationErrorPayloadUnionTypeResolver::class, AbstractRootCreateCategoryMutationErrorPayloadUnionTypeResolver::class, AbstractRootUpdateCategoryMutationErrorPayloadUnionTypeResolver::class];
    }
}
