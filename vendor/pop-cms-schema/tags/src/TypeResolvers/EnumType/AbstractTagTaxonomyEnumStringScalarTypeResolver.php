...
abstract class AbstractTagTaxonomyEnumStringScalarTypeResolver extends AbstractEnumStringScalarTypeResolver
{
    ...
    {
        return \sprintf($this->__('Tag taxonomies (available for querying via the API), with possible values: `"%s"`.', 'tags'), \implode('"`, `"', $this->getConsolidatedPossibleValues()));
    }
    /**
     * @return string[]
     */
    public function getPossibleValues() : array
    {
        ...
        return \array_values(\array_intersect($registeredCustomPostTagTaxonomyNames, $queryableTagTaxonomies));
    }
    /**
     ...
     * @return string[]|null
     */
    protected abstract function getRegisteredCustomPostTagTaxonomyNames() : ?array;
}
