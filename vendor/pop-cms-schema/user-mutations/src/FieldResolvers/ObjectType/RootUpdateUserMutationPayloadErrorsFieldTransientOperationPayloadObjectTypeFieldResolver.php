...
class RootUpdateUserMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getRootUpdateUserMutationErrorPayloadUnionTypeResolver() : RootUpdateUserMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [RootUpdateUserMutationPayloadObjectTypeResolver::class];
    }
