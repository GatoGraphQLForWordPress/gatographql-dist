...
class UserMutationTransientEntityOperationPayloadObjectTypeFieldResolver extends AbstractTransientEntityOperationPayloadObjectTypeFieldResolver
{
    ...
    {
        return [RootCreateUserMutationPayloadObjectTypeResolver::class, RootUpdateUserMutationPayloadObjectTypeResolver::class, UserUpdateMutationPayloadObjectTypeResolver::class];
    }
}
