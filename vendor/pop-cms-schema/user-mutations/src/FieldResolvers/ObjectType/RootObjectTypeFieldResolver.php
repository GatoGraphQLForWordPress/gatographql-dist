...
class RootObjectTypeFieldResolver extends AbstractObjectTypeFieldResolver
{
    ...
    protected final function getCreateUserMutationResolver() : CreateUserMutationResolver
    {
    ...
    protected final function getCreateUserBulkOperationMutationResolver() : CreateUserBulkOperationMutationResolver
    {
    ...
    protected final function getUpdateUserMutationResolver() : UpdateUserMutationResolver
    {
    ...
    protected final function getUpdateUserBulkOperationMutationResolver() : UpdateUserBulkOperationMutationResolver
    {
    ...
    protected final function getDeleteUserMutationResolver() : DeleteUserMutationResolver
    {
    ...
    protected final function getDeleteUserBulkOperationMutationResolver() : DeleteUserBulkOperationMutationResolver
    {
    ...
    protected final function getPayloadableCreateUserMutationResolver() : PayloadableCreateUserMutationResolver
    {
    ...
    protected final function getPayloadableCreateUserBulkOperationMutationResolver() : PayloadableCreateUserBulkOperationMutationResolver
    {
    ...
    protected final function getPayloadableUpdateUserMutationResolver() : PayloadableUpdateUserMutationResolver
    {
    ...
    protected final function getPayloadableUpdateUserBulkOperationMutationResolver() : PayloadableUpdateUserBulkOperationMutationResolver
    {
    ...
    protected final function getPayloadableDeleteUserMutationResolver() : PayloadableDeleteUserMutationResolver
    {
    ...
    protected final function getPayloadableDeleteUserBulkOperationMutationResolver() : PayloadableDeleteUserBulkOperationMutationResolver
    {
    ...
    protected final function getRootCreateUserInputObjectTypeResolver() : RootCreateUserInputObjectTypeResolver
    {
    ...
    protected final function getRootUpdateUserInputObjectTypeResolver() : RootUpdateUserInputObjectTypeResolver
    {
    ...
    protected final function getRootDeleteUserInputObjectTypeResolver() : RootDeleteUserInputObjectTypeResolver
    {
    ...
    protected final function getRootCreateUserMutationPayloadObjectTypeResolver() : RootCreateUserMutationPayloadObjectTypeResolver
    {
    ...
    protected final function getRootUpdateUserMutationPayloadObjectTypeResolver() : RootUpdateUserMutationPayloadObjectTypeResolver
    {
    ...
    protected final function getRootDeleteUserMutationPayloadObjectTypeResolver() : RootDeleteUserMutationPayloadObjectTypeResolver
    {
    ...
    public function getFieldNamesToResolve() : array
    {
        ...
        return \array_merge(['createUser', 'createUsers'], !$disableRedundantRootTypeMutationFields ? ['updateUser', 'updateUsers', 'deleteUser', 'deleteUsers'] : [], $addFieldsToQueryPayloadableUserMutations ? ['createUserMutationPayloadObjects'] : [], $addFieldsToQueryPayloadableUserMutations && !$disableRedundantRootTypeMutationFields ? ['updateUserMutationPayloadObjects', 'deleteUserMutationPayloadObjects'] : []);
    }
    ...
    public function getFieldTypeModifiers(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : int
    {
        ...
        if (!$usePayloadableUserMutations) {
            return match ($fieldName) {
                'createUser', 'updateUser' => SchemaTypeModifiers::NONE,
                'deleteUser' => SchemaTypeModifiers::NON_NULLABLE,
                'createUsers', 'updateUsers' => SchemaTypeModifiers::NON_NULLABLE | SchemaTypeModifiers::IS_ARRAY,
                'deleteUsers' => SchemaTypeModifiers::NON_NULLABLE | SchemaTypeModifiers::IS_ARRAY | SchemaTypeModifiers::IS_NON_NULLABLE_ITEMS_IN_ARRAY,
                default => parent::getFieldTypeModifiers($objectTypeResolver, $fieldName),
            };
        }
        if (\in_array($fieldName, ['createUserMutationPayloadObjects', 'updateUserMutationPayloadObjects', 'deleteUserMutationPayloadObjects'])) {
            return $this->getMutationPayloadObjectsFieldTypeModifiers();
        }
        return match ($fieldName) {
            'createUser', 'updateUser', 'deleteUser' => SchemaTypeModifiers::NON_NULLABLE,
            'createUsers', 'updateUsers', 'deleteUsers' => SchemaTypeModifiers::NON_NULLABLE | SchemaTypeModifiers::IS_ARRAY | SchemaTypeModifiers::IS_NON_NULLABLE_ITEMS_IN_ARRAY,
            default => parent::getFieldTypeModifiers($objectTypeResolver, $fieldName),
        };
    }
    /**
    ...
    {
        return match ($fieldName) {
            'createUser' => ['input' => $this->getRootCreateUserInputObjectTypeResolver()],
            'createUsers' => $this->getBulkOperationFieldArgNameTypeResolvers($this->getRootCreateUserInputObjectTypeResolver()),
            'updateUser' => ['input' => $this->getRootUpdateUserInputObjectTypeResolver()],
            'updateUsers' => $this->getBulkOperationFieldArgNameTypeResolvers($this->getRootUpdateUserInputObjectTypeResolver()),
            'deleteUser' => ['input' => $this->getRootDeleteUserInputObjectTypeResolver()],
            'deleteUsers' => $this->getBulkOperationFieldArgNameTypeResolvers($this->getRootDeleteUserInputObjectTypeResolver()),
            'createUserMutationPayloadObjects', 'updateUserMutationPayloadObjects', 'deleteUserMutationPayloadObjects' => $this->getMutationPayloadObjectsFieldArgNameTypeResolvers(),
    ...
    public function getFieldArgTypeModifiers(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName, string $fieldArgName) : int
    {
        ...
        if (\in_array($fieldName, ['createUsers', 'updateUsers', 'deleteUsers'])) {
        ...
        return match ([$fieldName => $fieldArgName]) {
            ['createUser' => 'input'], ['updateUser' => 'input'], ['deleteUser' => 'input'] => SchemaTypeModifiers::MANDATORY,
    ...
    public function getFieldMutationResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ?MutationResolverInterface
    {
        ...
        $usePayloadableUserMutations = $moduleConfiguration->usePayloadableUserMutations();
        return match ($fieldName) {
            'createUser' => $usePayloadableUserMutations ? $this->getPayloadableCreateUserMutationResolver() : $this->getCreateUserMutationResolver(),
            'createUsers' => $usePayloadableUserMutations ? $this->getPayloadableCreateUserBulkOperationMutationResolver() : $this->getCreateUserBulkOperationMutationResolver(),
            'updateUser' => $usePayloadableUserMutations ? $this->getPayloadableUpdateUserMutationResolver() : $this->getUpdateUserMutationResolver(),
            'updateUsers' => $usePayloadableUserMutations ? $this->getPayloadableUpdateUserBulkOperationMutationResolver() : $this->getUpdateUserBulkOperationMutationResolver(),
            'deleteUser' => $usePayloadableUserMutations ? $this->getPayloadableDeleteUserMutationResolver() : $this->getDeleteUserMutationResolver(),
            'deleteUsers' => $usePayloadableUserMutations ? $this->getPayloadableDeleteUserBulkOperationMutationResolver() : $this->getDeleteUserBulkOperationMutationResolver(),
    ...
    public function getFieldTypeResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ConcreteTypeResolverInterface
    {
        ...
        if ($usePayloadableUserMutations) {
            return match ($fieldName) {
                'createUser', 'createUsers', 'createUserMutationPayloadObjects' => $this->getRootCreateUserMutationPayloadObjectTypeResolver(),
                'updateUser', 'updateUsers', 'updateUserMutationPayloadObjects' => $this->getRootUpdateUserMutationPayloadObjectTypeResolver(),
                'deleteUser', 'deleteUsers', 'deleteUserMutationPayloadObjects' => $this->getRootDeleteUserMutationPayloadObjectTypeResolver(),
                default => parent::getFieldTypeResolver($objectTypeResolver, $fieldName),
            };
        }
        return match ($fieldName) {
            'createUser', 'createUsers', 'updateUser', 'updateUsers' => $this->getUserObjectTypeResolver(),
            'deleteUser', 'deleteUsers' => $this->getBooleanScalarTypeResolver(),
            default => parent::getFieldTypeResolver($objectTypeResolver, $fieldName),
        };
    }
    /**
