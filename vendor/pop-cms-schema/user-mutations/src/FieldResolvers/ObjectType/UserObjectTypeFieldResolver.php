...
class UserObjectTypeFieldResolver extends AbstractObjectTypeFieldResolver
{
    ...
    protected final function getUserUpdateInputObjectTypeResolver() : UserUpdateInputObjectTypeResolver
    {
    ...
    protected final function getUserUpdateMutationPayloadObjectTypeResolver() : UserUpdateMutationPayloadObjectTypeResolver
    {
    ...
    protected final function getUserDeleteInputObjectTypeResolver() : UserDeleteInputObjectTypeResolver
    {
    ...
    protected final function getUserDeleteMutationPayloadObjectTypeResolver() : UserDeleteMutationPayloadObjectTypeResolver
    {
    ...
    {
        return match ($fieldName) {
            'update' => ['input' => $this->getUserUpdateInputObjectTypeResolver()],
            'delete' => ['input' => $this->getUserDeleteInputObjectTypeResolver()],
    ...
    public function getFieldMutationResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ?MutationResolverInterface
    {
        ...
        $usePayloadableUserMutations = $moduleConfiguration->usePayloadableUserMutations();
        return match ($fieldName) {
            'update' => $usePayloadableUserMutations ? $this->getPayloadableUpdateUserMutationResolver() : $this->getUpdateUserMutationResolver(),
            'delete' => $usePayloadableUserMutations ? $this->getPayloadableDeleteUserMutationResolver() : $this->getDeleteUserMutationResolver(),
    ...
    public function getFieldTypeResolver(ObjectTypeResolverInterface $objectTypeResolver, string $fieldName) : ConcreteTypeResolverInterface
    {
        ...
        $usePayloadableUserMutations = $moduleConfiguration->usePayloadableUserMutations();
        return match ($fieldName) {
            'update' => $usePayloadableUserMutations ? $this->getUserUpdateMutationPayloadObjectTypeResolver() : $this->getUserObjectTypeResolver(),
            'delete' => $usePayloadableUserMutations ? $this->getUserDeleteMutationPayloadObjectTypeResolver() : $this->getBooleanScalarTypeResolver(),
