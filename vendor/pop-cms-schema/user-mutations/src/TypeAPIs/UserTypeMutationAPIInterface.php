...
interface UserTypeMutationAPIInterface
{
     ...
     */
    public function createUser(array $userData) : string|int;
    /**
     * @throws UserCRUDMutationException In case of error
     * @param array<string,mixed> $userData
     */
    public function updateUser(array $userData) : string|int;
    /**
     * @throws UserCRUDMutationException In case of error
     ...
     */
    public function deleteUser(string|int $userID, string|int|null $reassignAuthorContentToUserID) : void;
}
