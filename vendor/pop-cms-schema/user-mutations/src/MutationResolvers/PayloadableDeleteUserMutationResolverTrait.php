...
{
    use PayloadableMutationResolverTrait, \PoPCMSSchema\UserMutations\MutationResolvers\DeleteUserMutationResolverTrait {
        \PoPCMSSchema\UserMutations\MutationResolvers\DeleteUserMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof \PoPCMSSchema\UserMutations\MutationResolvers\DeleteUserMutationResolverTrait;
    }
    /**
    ...
    public function executeMutation(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : mixed
    {
        ...
        try {
            ...
            return $this->createFailureObjectMutationPayload([$this->createGenericErrorPayloadFromPayloadClientException($userCRUDMutationException)])->getID();
        }
    ...
    protected function createErrorPayloadFromObjectTypeFieldResolutionFeedback(ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback) : ErrorPayloadInterface
    {
        ...
        return match ([$feedbackItemResolution->getFeedbackProviderServiceClass(), $feedbackItemResolution->getCode()]) {
            ...
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E8] => new LoggedInUserHasNoPermissionToDeleteUserErrorPayload($feedbackItemResolution->getMessage()),
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E14] => new ReassignUserDoesNotExistErrorPayload($feedbackItemResolution->getMessage()),
            [MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E15] => new CannotDeleteYourselfErrorPayload($feedbackItemResolution->getMessage()),
