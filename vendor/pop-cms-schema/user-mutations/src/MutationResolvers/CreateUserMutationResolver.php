...
/** @internal */
class CreateUserMutationResolver extends \PoPCMSSchema\UserMutations\MutationResolvers\AbstractCreateOrUpdateUserMutationResolver
{
    protected function addUserInputField() : bool
    {
        return \false;
    }
    protected function validateUserCanExecuteMutation(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        if ($this->getUserTypeMutationAPI()->canLoggedInUserCreateUsers()) {
            return;
        }
        $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E7), $fieldDataAccessor->getField()));
    }
    public function validate(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        App::doAction(UserCRUDHookNames::VALIDATE_CREATE_USER, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    }
    protected function validateUsernameDoesNotExist(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        /** @var string|null */
        ...
        $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E10, [$username]), $fieldDataAccessor->getField()));
    }
