...
abstract class AbstractCreateOrUpdateUserMutationResolver extends AbstractMutationResolver
{
    ...
    use \PoPCMSSchema\UserMutations\MutationResolvers\UserMutationResolverTrait;
    ...
    {
        return new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E5);
    }
    protected abstract function addUserInputField() : bool;
    public function validate(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        App::doAction(UserCRUDHookNames::VALIDATE_CREATE_OR_UPDATE_USER, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    }
    protected abstract function validateUserCanExecuteMutation(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void;
    protected function validateEmail(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        if (!$this->getUserTypeMutationAPI()->isValidEmail($email)) {
            $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E12, [$email]), $fieldDataAccessor->getField()));
            return;
        }
        ...
        $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E11, [$email]), $fieldDataAccessor->getField()));
    }
    protected function validateRoles(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        foreach ($roles as $role) {
            ...
            $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(MutationErrorFeedbackItemProvider::class, MutationErrorFeedbackItemProvider::E13, [$role]), $fieldDataAccessor->getField()));
        }
        if ($objectTypeFieldResolutionFeedbackStore->getErrorCount() > $errorCount) {
            return;
        }
    ...
    protected function triggerExecuteCreateOrUpdateHook(string|int $userID, FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        App::doAction(UserCRUDHookNames::CREATE_OR_UPDATE_USER, $userID, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    }
    /**
    ...
    {
        $userData = [];
        foreach ([MutationInputProperties::USERNAME => 'username', MutationInputProperties::EMAIL => 'email', MutationInputProperties::PASSWORD => 'password', MutationInputProperties::FIRST_NAME => 'firstName', MutationInputProperties::LAST_NAME => 'lastName', MutationInputProperties::NICKNAME => 'nickname', MutationInputProperties::DISPLAY_NAME => 'displayName', MutationInputProperties::SLUG => 'slug', MutationInputProperties::WEBSITE_URL => 'websiteURL', MutationInputProperties::DESCRIPTION => 'description', MutationInputProperties::LOCALE => 'locale', MutationInputProperties::ROLES => 'roles', MutationInputProperties::SEND_EMAIL_NOTIFICATION => 'sendEmailNotification'] as $inputFieldName => $userDataKey) {
        ...
        return App::applyFilters(UserCRUDHookNames::GET_CREATE_OR_UPDATE_USER_DATA, $userData, $fieldDataAccessor);
    }
}
