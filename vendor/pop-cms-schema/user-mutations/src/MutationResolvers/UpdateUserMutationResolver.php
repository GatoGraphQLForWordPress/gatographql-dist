...
/** @internal */
class UpdateUserMutationResolver extends \PoPCMSSchema\UserMutations\MutationResolvers\AbstractCreateOrUpdateUserMutationResolver
{
    ...
    public function validate(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        App::doAction(UserCRUDHookNames::VALIDATE_UPDATE_USER, $fieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
    }
