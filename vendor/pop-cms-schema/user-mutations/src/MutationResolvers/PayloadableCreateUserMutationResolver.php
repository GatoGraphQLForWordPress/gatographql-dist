...
/** @internal */
class PayloadableCreateUserMutationResolver extends \PoPCMSSchema\UserMutations\MutationResolvers\CreateUserMutationResolver
{
    ...
    protected function createErrorPayloadFromObjectTypeFieldResolutionFeedback(ObjectTypeFieldResolutionFeedbackInterface $objectTypeFieldResolutionFeedback) : ErrorPayloadInterface
    {
        ...
        return App::applyFilters(UserCRUDHookNames::ERROR_PAYLOAD, $this->createCreateOrUpdateUserErrorPayloadFromObjectTypeFieldResolutionFeedback($objectTypeFieldResolutionFeedback) ?? new GenericErrorPayload($feedbackItemResolution->getMessage(), $feedbackItemResolution->getNamespacedCode()), $objectTypeFieldResolutionFeedback);
    }
}
