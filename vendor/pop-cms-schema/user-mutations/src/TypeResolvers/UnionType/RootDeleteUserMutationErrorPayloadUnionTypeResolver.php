...
/** @internal */
class RootDeleteUserMutationErrorPayloadUnionTypeResolver extends \PoPCMSSchema\UserMutations\TypeResolvers\UnionType\AbstractDeleteUserMutationErrorPayloadUnionTypeResolver
{
    private ?RootDeleteUserMutationErrorPayloadUnionTypeDataLoader $rootDeleteUserMutationErrorPayloadUnionTypeDataLoader = null;
    protected final function getRootDeleteUserMutationErrorPayloadUnionTypeDataLoader() : RootDeleteUserMutationErrorPayloadUnionTypeDataLoader
    {
