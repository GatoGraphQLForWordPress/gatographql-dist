...
/** @internal */
class RootCreateUserMutationErrorPayloadUnionTypeResolver extends \PoPCMSSchema\UserMutations\TypeResolvers\UnionType\AbstractCreateUserMutationErrorPayloadUnionTypeResolver
{
    private ?RootCreateUserMutationErrorPayloadUnionTypeDataLoader $rootCreateUserMutationErrorPayloadUnionTypeDataLoader = null;
    protected final function getRootCreateUserMutationErrorPayloadUnionTypeDataLoader() : RootCreateUserMutationErrorPayloadUnionTypeDataLoader
    {
