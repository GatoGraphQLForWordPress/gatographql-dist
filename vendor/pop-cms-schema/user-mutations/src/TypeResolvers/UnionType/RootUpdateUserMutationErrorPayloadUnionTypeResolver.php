...
/** @internal */
class RootUpdateUserMutationErrorPayloadUnionTypeResolver extends \PoPCMSSchema\UserMutations\TypeResolvers\UnionType\AbstractUpdateUserMutationErrorPayloadUnionTypeResolver
{
    private ?RootUpdateUserMutationErrorPayloadUnionTypeDataLoader $rootUpdateUserMutationErrorPayloadUnionTypeDataLoader = null;
    protected final function getRootUpdateUserMutationErrorPayloadUnionTypeDataLoader() : RootUpdateUserMutationErrorPayloadUnionTypeDataLoader
    {
