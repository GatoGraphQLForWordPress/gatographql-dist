...
/** @internal */
class UserUpdateMutationErrorPayloadUnionTypeResolver extends \PoPCMSSchema\UserMutations\TypeResolvers\UnionType\AbstractUpdateUserMutationErrorPayloadUnionTypeResolver
{
    private ?UserUpdateMutationErrorPayloadUnionTypeDataLoader $userUpdateMutationErrorPayloadUnionTypeDataLoader = null;
    protected final function getUserUpdateMutationErrorPayloadUnionTypeDataLoader() : UserUpdateMutationErrorPayloadUnionTypeDataLoader
    {
