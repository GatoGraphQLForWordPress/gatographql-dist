...
class LoggedInUserHasNoPermissionToCreateUsersErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoPermissionToCreateUsersErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoPermissionToCreateUsersErrorPayloadObjectTypeDataLoader
    {
