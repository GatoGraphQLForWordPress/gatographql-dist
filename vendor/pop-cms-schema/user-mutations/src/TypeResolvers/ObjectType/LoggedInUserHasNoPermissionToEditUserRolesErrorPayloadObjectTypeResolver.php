...
class LoggedInUserHasNoPermissionToEditUserRolesErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoPermissionToEditUserRolesErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoPermissionToEditUserRolesErrorPayloadObjectTypeDataLoader
    {
