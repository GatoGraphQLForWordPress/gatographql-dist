...
class LoggedInUserHasNoPermissionToDeleteUserErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteUserErrorPayloadObjectTypeDataLoader() : LoggedInUserHasNoPermissionToDeleteUserErrorPayloadObjectTypeDataLoader
    {
