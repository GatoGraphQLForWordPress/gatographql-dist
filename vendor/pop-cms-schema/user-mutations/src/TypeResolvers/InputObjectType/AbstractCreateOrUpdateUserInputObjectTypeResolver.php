...
/** @internal */
abstract class AbstractCreateOrUpdateUserInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements \PoPCMSSchema\UserMutations\TypeResolvers\InputObjectType\CreateUserInputObjectTypeResolverInterface
{
    ...
    {
        return \array_merge($this->addUserInputField() ? [MutationInputProperties::ID => $this->getIDScalarTypeResolver()] : [], $this->addUsernameInputField() ? [MutationInputProperties::USERNAME => $this->getStringScalarTypeResolver()] : [], [MutationInputProperties::EMAIL => $this->getEmailScalarTypeResolver(), MutationInputProperties::PASSWORD => $this->getStringScalarTypeResolver(), MutationInputProperties::ROLES => $this->getStringScalarTypeResolver(), MutationInputProperties::FIRST_NAME => $this->getStringScalarTypeResolver(), MutationInputProperties::LAST_NAME => $this->getStringScalarTypeResolver(), MutationInputProperties::NICKNAME => $this->getStringScalarTypeResolver(), MutationInputProperties::DISPLAY_NAME => $this->getStringScalarTypeResolver(), MutationInputProperties::SLUG => $this->getStringScalarTypeResolver(), MutationInputProperties::WEBSITE_URL => $this->getURLScalarTypeResolver(), MutationInputProperties::DESCRIPTION => $this->getStringScalarTypeResolver(), MutationInputProperties::LOCALE => $this->getStringScalarTypeResolver(), MutationInputProperties::REGISTERED_DATE => $this->getDateTimeScalarTypeResolver()], $this->addUsernameInputField() ? [MutationInputProperties::SEND_EMAIL_NOTIFICATION => $this->getBooleanScalarTypeResolver()] : []);
    }
    protected abstract function addUserInputField() : bool;
    protected abstract function addUsernameInputField() : bool;
    ...
    {
        return match ($inputFieldName) {
            MutationInputProperties::ID, MutationInputProperties::USERNAME => SchemaTypeModifiers::MANDATORY,
            MutationInputProperties::EMAIL => $this->addUsernameInputField() ? SchemaTypeModifiers::MANDATORY : SchemaTypeModifiers::NONE,
            MutationInputProperties::ROLES => SchemaTypeModifiers::IS_ARRAY | SchemaTypeModifiers::IS_NON_NULLABLE_ITEMS_IN_ARRAY,
