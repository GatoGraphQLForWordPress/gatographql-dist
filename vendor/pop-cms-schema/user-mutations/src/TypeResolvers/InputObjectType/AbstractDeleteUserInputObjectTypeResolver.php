...
/** @internal */
abstract class AbstractDeleteUserInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements \PoPCMSSchema\UserMutations\TypeResolvers\InputObjectType\DeleteUserInputObjectTypeResolverInterface
{
    ...
    {
        return \array_merge($this->addIDInputField() ? [MutationInputProperties::ID => $this->getIDScalarTypeResolver()] : [], [MutationInputProperties::REASSIGN_AUTHOR_CONTENT_TO => $this->getIDScalarTypeResolver()]);
    }
