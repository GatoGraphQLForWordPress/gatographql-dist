...
class LoggedInUserHasNoPermissionToCreateUsersErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getLoggedInUserHasNoPermissionToCreateUsersErrorPayloadObjectTypeResolver() : LoggedInUserHasNoPermissionToCreateUsersErrorPayloadObjectTypeResolver
    {
    ...
    {
        return [AbstractCreateUserMutationErrorPayloadUnionTypeResolver::class];
    }
}
