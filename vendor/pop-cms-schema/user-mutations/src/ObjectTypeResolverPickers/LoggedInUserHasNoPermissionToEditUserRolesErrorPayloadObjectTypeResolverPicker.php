...
class LoggedInUserHasNoPermissionToEditUserRolesErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getLoggedInUserHasNoPermissionToEditUserRolesErrorPayloadObjectTypeResolver() : LoggedInUserHasNoPermissionToEditUserRolesErrorPayloadObjectTypeResolver
    {
    ...
    {
        return [AbstractCreateOrUpdateUserMutationErrorPayloadUnionTypeResolver::class];
    }
}
