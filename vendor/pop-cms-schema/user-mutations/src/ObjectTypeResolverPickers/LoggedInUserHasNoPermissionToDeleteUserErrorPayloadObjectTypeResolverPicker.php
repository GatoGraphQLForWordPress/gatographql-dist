...
class LoggedInUserHasNoPermissionToDeleteUserErrorPayloadObjectTypeResolverPicker extends AbstractErrorPayloadObjectTypeResolverPicker
{
    ...
    protected final function getLoggedInUserHasNoPermissionToDeleteUserErrorPayloadObjectTypeResolver() : LoggedInUserHasNoPermissionToDeleteUserErrorPayloadObjectTypeResolver
    {
    ...
    {
        return [AbstractDeleteUserMutationErrorPayloadUnionTypeResolver::class];
    }
}
