...
trait GenericCategoryMutationResolverHookSetTrait
{
    ...
    {
        return $inputObjectTypeResolver instanceof CreateGenericCategoryTermInputObjectTypeResolverInterface || $inputObjectTypeResolver instanceof UpdateGenericCategoryTermInputObjectTypeResolverInterface;
    }
}
