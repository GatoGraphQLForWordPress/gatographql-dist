...
class CommonFilterInputComponentProcessor extends AbstractFilterInputComponentProcessor implements DataloadQueryArgsFilterInputComponentProcessorInterface
{
    ...
    public function getFilterInputDescription(Component $component) : ?string
    {
        return match ((string) $component->name) {
            ...
            self::COMPONENT_FILTERINPUT_COMMASEPARATED_IDS => \sprintf($this->__('Limit results to elements with the given ID, or IDs (separated by \'%s\')', 'gatographql'), Param::VALUE_SEPARATOR),
            ...
            self::COMPONENT_FILTERINPUT_SLUGS => $this->__('Limit results to elements with the given slug', 'gatographql'),
            self::COMPONENT_FILTERINPUT_DATEFORMAT => \sprintf($this->__('Date format, as defined in %s', 'gatographql'), 'https://www.php.net/manual/en/function.date.php'),
