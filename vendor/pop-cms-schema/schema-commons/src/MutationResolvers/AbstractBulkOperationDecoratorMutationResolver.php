...
abstract class AbstractBulkOperationDecoratorMutationResolver extends AbstractMutationResolver
{
     ...
     */
    protected function getInputObjectListItemSubpropertyFieldDataAccessors(FieldDataAccessorInterface $fieldDataAccessor) : array
    {
        ...
        foreach ($inputs as $position => $input) {
            $inputObjectListItemSubpropertyFieldDataAccessors[] = new InputObjectListItemSubpropertyFieldDataAccessor($fieldDataAccessor->getField(), MutationInputProperties::INPUTS, $position, $fieldDataAccessor->getFieldArgs());
        }
    ...
    public function executeMutation(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore)
    {
        ...
        foreach ($inputs as $position => $input) {
            ...
            $result = $decoratedOperationMutationResolver->executeMutation($inputObjectListItemSubpropertyFieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
            $results[] = $result;
    ...
    protected abstract function getDecoratedOperationMutationResolver() : MutationResolverInterface;
    public function validate(FieldDataAccessorInterface $fieldDataAccessor, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        foreach ($inputs as $position => $input) {
            /** @var InputObjectListItemSubpropertyFieldDataAccessor */
            $inputObjectListItemSubpropertyFieldDataAccessor = $inputObjectListItemSubpropertyFieldDataAccessors[$position];
            $decoratedOperationMutationResolver->validate($inputObjectListItemSubpropertyFieldDataAccessor, $objectTypeFieldResolutionFeedbackStore);
        }
    }
}
