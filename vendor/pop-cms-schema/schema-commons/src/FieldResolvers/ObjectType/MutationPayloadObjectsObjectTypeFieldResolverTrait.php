...
trait MutationPayloadObjectsObjectTypeFieldResolverTrait
{
    ...
    {
        return [MutationInputProperties::INPUT => $this->getMutationPayloadObjectsInputObjectTypeResolver()];
    }
     ...
     */
    protected function retrieveInputIDsFromObjectDictionary(string $objectClass, FieldDataAccessorInterface $fieldDataAccessor) : array
    {
        /** @var stdClass */
