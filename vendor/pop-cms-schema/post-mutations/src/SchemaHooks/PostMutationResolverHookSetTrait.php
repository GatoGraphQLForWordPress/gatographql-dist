...
trait PostMutationResolverHookSetTrait
{
    ...
    {
        return $inputObjectTypeResolver instanceof CreatePostInputObjectTypeResolverInterface || $inputObjectTypeResolver instanceof UpdatePostInputObjectTypeResolverInterface;
    }
}
