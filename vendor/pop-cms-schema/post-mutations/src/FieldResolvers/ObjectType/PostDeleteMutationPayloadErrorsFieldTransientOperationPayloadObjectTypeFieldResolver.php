...
class PostDeleteMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    protected final function getPostDeleteMutationErrorPayloadUnionTypeResolver() : PostDeleteMutationErrorPayloadUnionTypeResolver
    {
    ...
    {
        return [PostDeleteMutationPayloadObjectTypeResolver::class];
    }
