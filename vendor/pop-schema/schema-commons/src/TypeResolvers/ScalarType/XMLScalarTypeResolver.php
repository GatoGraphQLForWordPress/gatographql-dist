...
class XMLScalarTypeResolver extends AbstractScalarTypeResolver
{
    ...
    protected final function validateIsXML(string $inputValue, AstInterface $astNode, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
