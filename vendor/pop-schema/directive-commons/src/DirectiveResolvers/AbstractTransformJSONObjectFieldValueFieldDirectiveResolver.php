...
abstract class AbstractTransformJSONObjectFieldValueFieldDirectiveResolver extends \PoPSchema\DirectiveCommons\DirectiveResolvers\AbstractTransformTypedFieldValueFieldDirectiveResolver
{
    ...
    {
        return [JSONObjectScalarTypeResolver::class, StringValueJSONObjectScalarTypeResolver::class, StringListValueJSONObjectScalarTypeResolver::class, NullableListValueJSONObjectScalarTypeResolver::class, ListValueJSONObjectScalarTypeResolver::class, IntValueJSONObjectScalarTypeResolver::class, IDValueJSONObjectScalarTypeResolver::class, CodeNameJSONObjectScalarTypeResolver::class];
    }
