...
/** @internal */
class StringFunctionHelperService implements \PoPSchema\ExtendedSchemaCommons\HelperServices\StringFunctionHelperServiceInterface
{
     ...
     */
    public function quoteRegex(string $string, ?string $delimiter = null) : string
    {
