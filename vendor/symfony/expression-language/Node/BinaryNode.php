...
class BinaryNode extends Node
{
    ...
    private const FUNCTIONS = ['**' => 'pow', '..' => 'range', 'in' => '\\' . self::class . '::inArray', 'not in' => '!\\' . self::class . '::inArray', 'contains' => 'str_contains', 'starts with' => 'str_starts_with', 'ends with' => 'str_ends_with'];
