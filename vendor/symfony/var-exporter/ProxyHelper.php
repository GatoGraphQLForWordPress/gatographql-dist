...
use GatoExternalPrefixByGatoGraphQL\Symfony\Component\VarExporter\Internal\LazyObjectRegistry;
/**
...
EOPHP;
    ...
    private static function exportDefault(\ReflectionParameter $param, $namespace) : string
    {
        ...
        if (\str_starts_with($default, "'") && \str_ends_with($default, "'") || \str_starts_with($default, '[') && \str_ends_with($default, ']')) {
