...
if (\version_compare(\phpversion('relay'), '0.30.0', '>=')) {
    ...
    trait Relay30Trait
    {
        public function increx($key, $value = null, $options = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|array|false
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->increx(...\func_get_args());
        }
        public function unwatch() : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|bool|string
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->unwatch(...\func_get_args());
        }
        public function xnack($key, $group, $mode, $ids, $options = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|false|int
        {
