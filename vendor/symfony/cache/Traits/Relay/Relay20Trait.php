...
if (\version_compare(\phpversion('relay'), '0.20.0', '>=')) {
    ...
    trait Relay20Trait
    {
        ...
        public function delex($key, $options = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|false|int
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->delex(...\func_get_args());
        }
        public function digest($key) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|false|null|string
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->digest(...\func_get_args());
        }
        public function msetex($kvals, $ttl = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|false|int
        {
