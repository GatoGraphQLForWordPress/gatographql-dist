...
if (\version_compare(\phpversion('relay'), '0.40.0', '>=')) {
    ...
    trait Relay40Trait
    {
        public function blmovem($srckey, $dstkey, $srcpos, $dstpos, $timeout, $options = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|array|false
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->blmovem(...\func_get_args());
        }
        public function lmovem($srckey, $dstkey, $srcpos, $dstpos, $options = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|array|false
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->lmovem(...\func_get_args());
        }
        public function sdiffcard($keys, $options = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|false|int
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->sdiffcard(...\func_get_args());
        }
        public function sunioncard($keys, $options = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|false|int
        {
