...
if (\version_compare(\phpversion('relay'), '0.21.0', '>=')) {
    ...
    trait Relay21Trait
    {
        public function gcra($key, $maxBurst, $requestsPerPeriod, $period, $tokens = 0) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|array|false
        {
            return ($this->lazyObjectState->realInstance ??= ($this->lazyObjectState->initializer)())->gcra(...\func_get_args());
        }
        public function hotkeys($subcmd, $args = null) : \GatoExternalPrefixByGatoGraphQL\Relay\Relay|array|bool
        {
