...
class Redis5Proxy extends \Redis implements ResetInterface, LazyObjectInterface
{
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->evaluate(...\func_get_args());
    }
    public function evaluateSha($script_sha, $args = null, $num_keys = null)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->evaluateSha(...\func_get_args());
    }
    public function getKeys($pattern)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->getKeys(...\func_get_args());
    }
    public function getMultiple($keys)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->getMultiple(...\func_get_args());
    }
    public function lGet($key, $index)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->lGet(...\func_get_args());
    }
    public function lGetRange($key, $start, $end)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->lGetRange(...\func_get_args());
    }
    public function lRemove($key, $value, $count)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->lRemove(...\func_get_args());
    }
    public function lSize($key)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->lSize(...\func_get_args());
    }
    public function listTrim($key, $start, $stop)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->listTrim(...\func_get_args());
    }
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->renameKey(...\func_get_args());
    }
    public function sContains($key, $value)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->sContains(...\func_get_args());
    }
    public function sGetMembers($key)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->sGetMembers(...\func_get_args());
    }
    public function sRemove($key, $member, ...$other_members)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->sRemove(...\func_get_args());
    }
    public function sSize($key)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->sSize(...\func_get_args());
    }
    public function sendEcho($msg)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->sendEcho(...\func_get_args());
    }
    public function setTimeout($key, $timeout)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->setTimeout(...\func_get_args());
    }
    public function substr($key, $start, $end)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->substr(...\func_get_args());
    }
    public function zDelete($key, $member, ...$other_members)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zDelete(...\func_get_args());
    }
    public function zDeleteRangeByRank($key, $min, $max)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zDeleteRangeByRank(...\func_get_args());
    }
    public function zDeleteRangeByScore($key, $min, $max)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zDeleteRangeByScore(...\func_get_args());
    }
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zRemove(...\func_get_args());
    }
    public function zRemoveRangeByScore($key, $min, $max)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zRemoveRangeByScore(...\func_get_args());
    }
    public function zReverseRange($key, $start, $end, $scores = null)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zReverseRange(...\func_get_args());
    }
    public function zSize($key)
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zSize(...\func_get_args());
    }
