...
abstract class AbstractSwitchAppThreadStandaloneGraphQLServer extends \GraphQLByPoP\GraphQLServer\Server\StandaloneGraphQLServer
{
    ...
    public function __construct(array $moduleClasses, array $moduleClassConfiguration = [], array $systemContainerCompilerPassClasses = [], array $applicationContainerCompilerPassClasses = [], ?ContainerCacheConfiguration $containerCacheConfiguration = null)
    {
        ...
        parent::__construct($moduleClasses, $moduleClassConfiguration, $systemContainerCompilerPassClasses, $applicationContainerCompilerPassClasses, $containerCacheConfiguration);
