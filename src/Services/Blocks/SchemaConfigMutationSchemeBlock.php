...
class SchemaConfigMutationSchemeBlock extends AbstractSchemaConfigBlock
{
    ...
    public function renderBlock(array $attributes, string $content): string
    {
        ...
        $mutationSchemeLabels = [
            ...
            MutationSchemes::NESTED_WITH_REDUNDANT_ROOT_FIELDS => \__('✅ Nested mutations enabled, keeping all mutation fields in the Root type', 'gatographql'),
            MutationSchemes::NESTED_WITHOUT_REDUNDANT_ROOT_FIELDS => \__('✳️ Nested mutations enabled, removing the redundant mutation fields from the Root type', 'gatographql'),
        ];
        /** @var ModuleConfiguration */
        $moduleConfiguration = App::getModule(Module::class)->getConfiguration();
        $blockContent = sprintf(
            $blockContentPlaceholder,
            \__('Mutation Scheme', 'gatographql'),
