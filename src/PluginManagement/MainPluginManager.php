    ...
    public function assertIsValid(
        ...
        if ($this->mainPlugin !== null) {
            $this->printAdminNoticeErrorMessage(
                sprintf(
                    __('Plugin <strong>%s</strong> is already installed with version <code>%s</code>, so version <code>%s</code> has not been loaded. Please deactivate all versions, remove the older version, and activate again the latest version of the plugin.'),
    ...
    public function getPlugin(): MainPluginInterface
    {
        if ($this->mainPlugin === null) {
            throw new MainPluginNotRegisteredException(
                __('The main plugin has not been registered yet')
            );
        }
