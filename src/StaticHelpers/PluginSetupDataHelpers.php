...
class PluginSetupDataHelpers
{
     ...
     * @param string|string[] $status
     */
    public static function getPersistedQueryEndpointID(string $slug, $status = ['publish', 'private']): ?int
    {
        $instanceManager = InstanceManagerFacade::getInstance();
     ...
     * @param string|string[] $status
     */
    public static function getCustomEndpointID(string $slug, $status = ['publish', 'private']): ?int
    {
        $instanceManager = InstanceManagerFacade::getInstance();
