...
abstract class AbstractMainPlugin extends AbstractPlugin implements MainPluginInterface
{
    ...
    public function setup(): void
    {
         ...
         */
        add_action('activate_plugin', \Closure::fromCallable([$this, 'maybeRegenerateContainerWhenPluginActivatedOrDeactivated']));
        add_action('deactivate_plugin', \Closure::fromCallable([$this, 'maybeRegenerateContainerWhenPluginActivatedOrDeactivated']));
