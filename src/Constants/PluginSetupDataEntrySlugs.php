...
class PluginSetupDataEntrySlugs
{
    ...
    public const PERSISTED_QUERY_CREATE_MISSING_TRANSLATION_CATEGORIES_FOR_POLYLANG = 'create-missing-translation-categories-for-polylang';
    public const PERSISTED_QUERY_CREATE_MISSING_TRANSLATION_CUSTOMPOSTS_FOR_POLYLANG = 'create-missing-translation-customposts-for-polylang';
    public const PERSISTED_QUERY_CREATE_MISSING_TRANSLATION_MEDIA_FOR_POLYLANG = 'create-missing-translation-media-for-polylang';
    public const PERSISTED_QUERY_CREATE_MISSING_TRANSLATION_TAGS_FOR_POLYLANG = 'create-missing-translation-tags-for-polylang';
    ...
    public const PERSISTED_QUERY_IMPORT_HTML_FROM_URLS_AS_NEW_POSTS_IN_WORDPRESS = 'import-html-from-urls-as-new-posts-in-wordpress';
    public const PERSISTED_QUERY_IMPORT_NEW_POSTS_FROM_WORDPRESS_RSS_FEED = 'import-new-posts-from-wordpress-rss-feed';
    public const PERSISTED_QUERY_IMPORT_POST_FROM_WORDPRESS_RSS_FEED = 'import-post-from-wordpress-rss-feed';
    public const PERSISTED_QUERY_IMPORT_POST_FROM_WORDPRESS_RSS_FEED_AND_REWRITE_ITS_CONTENT_WITH_CHATGPT = 'import-post-from-wp-rss-feed-and-rewrite-content-with-chatgpt';
    ...
    public const PERSISTED_QUERY_SYNC_CUSTOMPOST_CATEGORIES_FOR_POLYLANG = 'sync-custompost-categories-for-polylang';
    public const PERSISTED_QUERY_SYNC_CUSTOMPOST_FEATUREDIMAGE_FOR_POLYLANG = 'sync-custompost-featuredimage-for-polylang';
    public const PERSISTED_QUERY_SYNC_CUSTOMPOST_TAGS_FOR_POLYLANG = 'sync-custompost-tags-for-polylang';
    ...
    public const PERSISTED_QUERY_TRANSLATE_CATEGORIES_FOR_MULTILINGUALPRESS = 'translate-categories-for-multilingualpress';
    public const PERSISTED_QUERY_TRANSLATE_CATEGORIES_FOR_POLYLANG = 'translate-categories-for-polylang';
    public const PERSISTED_QUERY_TRANSLATE_CUSTOMPOSTS_FOR_POLYLANG_CLASSIC_EDITOR = 'translate-customposts-for-polylang-classic-editor';
    public const PERSISTED_QUERY_TRANSLATE_CUSTOMPOSTS_FOR_POLYLANG_GUTENBERG = 'translate-customposts-for-polylang-gutenberg';
    public const PERSISTED_QUERY_TRANSLATE_MEDIA_FOR_POLYLANG = 'translate-media-for-polylang';
    ...
    public const PERSISTED_QUERY_TRANSLATE_TAGS_FOR_MULTILINGUALPRESS = 'translate-tags-for-multilingualpress';
    public const PERSISTED_QUERY_TRANSLATE_TAGS_FOR_POLYLANG = 'translate-tags-for-polylang';
}
